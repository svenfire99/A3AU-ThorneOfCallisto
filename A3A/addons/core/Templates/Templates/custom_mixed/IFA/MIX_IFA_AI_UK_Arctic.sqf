/* Faction : UK
 * Converted from: IFA_AI_UK_Arctic.sqf
 */
_basic append ["LIB_UK_Willys_MB_w"];
_lightUnarmed append ["LIB_UK_Willys_MB_w","LIB_UK_Willys_MB_Hood_w"];
_lightArmed append ["LIB_UK_Willys_MB_M1919_w","LIB_UniversalCarrier_w"];
...
_IFVs append ["LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_w", "LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Crocodile_w", "LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Howitzer_w", "LIB_Churchill_Mk7_AVRE_w"];
_airborneVehicles append ["LIB_UniversalCarrier_w"];
_tanks append ["LIB_M4A4_FIREFLY"];
_lightTanks append ["LIB_Cromwell_Mk4_w"];
...
_traitorUniforms append ["U_LIB_UK_P37_w"];
_traitorVests append ["V_LIB_UK_P37_Holster_Blanco"];
_traitorHats append ["H_LIB_UK_Helmet_Mk2_w"];

_officerUniforms append ["U_LIB_UK_P37Jerkins_w"];
_officerVests append ["V_LIB_UK_P37_Holster_Blanco"];
_officerHats append ["H_LIB_UK_Helmet_Mk2_w"];
