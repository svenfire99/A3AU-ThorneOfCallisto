/* Faction : UK
 * Converted from: IFA_AI_UK_Arid.sqf
 */
...
_IFVs append ["LIB_Churchill_Mk7_desert", "LIB_Churchill_Mk7_Crocodile_desert", "LIB_Churchill_Mk7_Howitzer_desert", "LIB_Churchill_Mk7_AVRE_desert"];
_airborneVehicles append ["LIB_UniversalCarrier_desert"];
_tanks append ["LIB_UK_DR_M4A3_75", "LIB_UK_Italy_M4A3_75"];
_lightTanks append ["LIB_Churchill_Mk7_desert"];
