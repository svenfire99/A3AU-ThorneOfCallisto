/* Faction : IFA_CIV_Zombie_Soldiers
 * Converted from: IFA_CIV_Zombie_Soldiers.sqf
 */
...
_faces append ["LivonianHead_6","RussianHead_1","RussianHead_2","RussianHead_3","RussianHead_4","RussianHead_5","LIB_aleksei_IF","LIB_boyartsev_IF","LIB_bykov_IF","LIB_Otto_IF","LIB_Volker_IF","LIB_Walter_IF","LIB_Wolf_IF"];
_voices append [];
_sfVoices append [];
_eliteVoices append [];
