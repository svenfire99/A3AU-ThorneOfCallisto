...
_APCs append ["LIB_Scout_M3_FFV","LIB_SOV_M3_Halftrack"];
_IFVs append ["LIB_SU85", "LIB_T34_76"];
_airborneVehicles append ["LIB_Scout_M3_FFV"];
_tanks append ["LIB_T34_85","LIB_T34_85","LIB_T34_85","LIB_JS2_43"];
_lightTanks append ["LIB_T34_76"];
...
_sfuniforms append ["U_LIB_SOV_Razvedchik_am"];
...
_sfhelmets append ["H_LIB_SOV_RA_Helmet"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append ["H_LIB_SOV_RA_Helmet"];
_sfSNIhats append ["H_LIB_SOV_RA_Helmet"];
...
_eliteuniforms append ["U_LIB_SOV_Strelok_summer"];
_eliteSLuniforms append ["U_LIB_SOV_Kapitan_summer"];
...
_elitehelmets append ["H_LIB_SOV_RA_PrivateCap","H_LIB_SOV_RA_Helmet"];
_eliteMEDhelmets append [];
_eliteSLhelmets append [];
_eliteSLhats append ["H_LIB_SOV_RA_Helmet"];
_eliteSNIhats append ["H_LIB_SOV_RA_PrivateCap","H_LIB_SOV_RA_Helmet"];
...
_militaryuniforms append ["U_LIB_SOV_Strelok_summer"];
_militaryENGuniforms append [];
_militarySLuniforms append ["U_LIB_SOV_Kapitan_summer"];
...
_militaryhelmets append ["H_LIB_SOV_RA_PrivateCap","H_LIB_SOV_RA_Helmet"];
_militaryMEDhelmets append [];
_militarySLhelmets append [];
_militarySLhats append ["H_LIB_SOV_RA_Helmet"];
_militarySNIhats append ["H_LIB_SOV_RA_PrivateCap","H_LIB_SOV_RA_Helmet"];
...
_militiauniforms append ["U_LIB_SOV_Strelok_summer"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append ["U_LIB_SOV_Sergeant"];
...
_militiahelmets append ["H_LIB_SOV_RA_PrivateCap"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append ["H_LIB_SOV_RA_PrivateCap"];
_militiaSNIhats append ["H_LIB_SOV_RA_PrivateCap"];
