...
_staticAT append ["LIB_DAK_Pak40"];
...
_traitorUniforms append ["U_LIB_DAK_Sentry"];
_traitorVests append ["V_LIB_DAK_OfficerVest"];
_traitorHats append ["H_LIB_DAK_PithHelmet"];

_officerUniforms append ["U_LIB_DAK_NCO"];
_officerVests append ["V_LIB_DAK_OfficerVest"];
_officerHats append ["H_LIB_DAK_PithHelmet"];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["H_LIB_DAK_PithHelmet"];
_SNIhats append ["H_LIB_DAK_PithHelmet"];
