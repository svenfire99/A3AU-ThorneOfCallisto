/* Faction : USA
 * Converted from: IFA_AI_USA_Temperate.sqf
 */
...
_tanks append ["LIB_M4A3_76","LIB_M4A3_76_HVSS","LIB_M4A3_75","LIB_M4A3_75"];
...
_officerUniforms append ["U_LIB_US_Rangers_Sergeant"];
_officerVests append ["V_LIB_US_AB_Vest_Padded_Carbine"];
_officerHats append ["H_LIB_US_Rangers_Helmet"];
...
_sfuniforms append ["U_LIB_US_AB_Uniform_M43", "U_LIB_US_AB_Uniform_M43_corporal", "U_LIB_US_AB_Uniform_M43_NCO"];
