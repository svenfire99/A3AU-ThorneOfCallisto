/* Faction : Allies
 * Converted from: IFA_AI_Allies_Temperate.sqf
 */
_basic append ["LIB_US_Willys_MB"];
_lightUnarmed append ["LIB_US_Willys_MB","LIB_US_Willys_MB_Hood"];
...
_lightAPCs append ["LIB_US_Scout_M3"];
_APCs append ["LIB_US_M3_Halftrack","LIB_US_Scout_M3_FFV"];
_IFVs append ["LIB_M8_Greyhound", "LIB_M3A3_Stuart", "LIB_M5A1_Stuart", "LIB_Churchill_Mk7_Howitzer", "LIB_Churchill_Mk7_AVRE"];
_airborneVehicles append ["LIB_US_Scout_M3"];
_tanks append ["LIB_M4A3_76","LIB_M4A3_76_HVSS","LIB_M4A3_75","LIB_M4A3_75", "LIB_Churchill_Mk7", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Crocodile", "LIB_M4A4_FIREFLY"];
...
_traitorUniforms append ["U_LIB_US_Rangers_Uniform"];
_traitorVests append ["V_LIB_US_AB_Vest_Padded_Carbine"];
_traitorHats append ["H_LIB_US_Rangers_Helmet"];
...
_eliteuniforms append ["U_LIB_US_Rangers_Uniform", "U_LIB_US_Rangers_Corp", "U_LIB_US_Rangers_Private_1st"];
...
_militaryuniforms append ["U_LIB_US_Rangers_Uniform", "U_LIB_US_Rangers_Corp", "U_LIB_US_Rangers_Private_1st"];
...
_policeuniforms append ["U_LIB_US_Private"];
