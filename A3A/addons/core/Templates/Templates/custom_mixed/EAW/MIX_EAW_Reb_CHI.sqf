/* Faction : ROC
 * Converted from: EAW_Reb_CHI.sqf
 */
...
_staticMG append ["EAW_Type24_MG"];
_staticAT append ["EAW_ROC_Pak36"];
_staticAA append ["LIB_FlaK_30"];
_staticMortars append ["EAW_ROC_Type20_Mortar"];
_howitzers append [];
_radar append [];
_SAM append [];
