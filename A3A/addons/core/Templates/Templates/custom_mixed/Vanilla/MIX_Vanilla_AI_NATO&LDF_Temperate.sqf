/* Faction : NATOxLDF
 * Converted from: Vanilla_AI_NATO&LDF_Temperate.sqf
 */
...
_cargoTrucks append ["B_T_Truck_01_flatbed_F", "B_T_Truck_01_cargo_F","B_T_UGV_01_olive_F","I_E_Truck_02_transport_F", "I_E_Truck_02_F"];
_ammoTrucks append ["B_T_Truck_01_ammo_F","I_E_Truck_02_Ammo_F"];
_repairTrucks append ["B_T_Truck_01_Repair_F","B_T_APC_Tracked_01_CRV_F","I_E_Truck_02_Box_F"];
_fuelTrucks append ["B_T_Truck_01_fuel_F","I_E_Truck_02_fuel_F"];
_medicalTrucks append ["B_T_Truck_01_medical_F","I_E_Truck_02_medical_F"];
...
_airborneVehicles append ["B_T_APC_Wheeled_01_cannon_F","B_T_UGV_01_olive_F","I_E_APC_tracked_03_cannon_F"];
...
_helisLight append ["B_Heli_Light_01_F","I_E_Heli_light_03_unarmed_F"];
_transportHelicopters append ["B_Heli_Transport_01_F","B_CTRG_Heli_Transport_01_tropic_F","B_Heli_Transport_01_camo_F"];
_helisLightAttack append ["B_Heli_Light_01_dynamicLoadout_F","I_E_Heli_light_03_dynamicLoadout_F"];
_helisAttack append ["B_Heli_Attack_01_dynamicLoadout_F"];
_airPatrol append [];

_artillery append ["B_T_MBT_01_arty_F","B_T_MBT_01_mlrs_F","I_E_Truck_02_MRL_F"];
...
_militiaLightArmed append ["a3a_Offroad_01_ldf_armed_F", "a3a_Offroad_01_ldf_AT_F","B_T_MRAP_01_hmg_F", "B_T_MRAP_01_gmg_F"];
_militiaTrucks append ["I_E_Truck_02_F", "I_E_Truck_02_transport_F"];
_militiaCars append ["I_E_Offroad_01_F", "I_E_Offroad_01_comms_F", "I_E_Offroad_01_covered_F","B_T_MRAP_01_F"];
_militiaAPCs append ["B_T_APC_Wheeled_01_cannon_F","I_E_APC_tracked_03_cannon_F","B_T_APC_Tracked_01_rcws_F"];
...
_militaryvests append ["V_Chestrig_oli", "V_PlateCarrier1_wdl","V_TacVestIR_blk","V_CarrierRigKBT_01_Olive_F", "V_PlateCarrier2_wdl"];
_militaryHvests append ["V_PlateCarrier2_wdl","V_PlateCarrier1_wdl", "V_PlateCarrierSpec_wdl"];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append [];
_militarySNIvests append [];
_militaryGLvests append ["V_Chestrig_oli", "V_PlateCarrier1_wdl","V_TacVestIR_blk", "V_PlateCarrier2_wdl", "V_PlateCarrierGL_wdl"];
_militaryATvests append [];
_militaryENGvests append [];
_militarybackpacks append ["B_AssaultPack_wdl_F","B_FieldPack_oli","B_FieldPack_green_F","B_Carryall_wdl_F", "B_Kitbag_sgg", "B_AssaultPack_rgr", "B_Kitbag_mcamo"];
_militaryATBackpacks append ["B_TacticalPack_oli","B_Carryall_wdl_F", "B_AssaultPack_rgr", "B_Kitbag_mcamo"];
...
_militaryhelmets append ["H_HelmetB_light_wdl", "H_MilCap_wdl", "H_Bandanna_camo","H_HelmetB_plain_wdl", "H_HelmetSpecB_wdl"];
...
_militiaNVGs append [];
_militiabinoculars append ["Rangefinder"];
_militiarangefinders append [];

_militiauniforms append ["U_I_E_Uniform_01_tanktop_F", "U_I_E_Uniform_01_shortsleeve_F","U_I_E_Uniform_01_F", "U_I_E_Uniform_01_sweater_F","U_O_R_Gorka_01_F","U_O_R_Gorka_01_camo_F","U_I_E_CBRN_Suit_01_EAF_F"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append ["U_I_E_Uniform_01_officer_F"];
_militiavests append ["V_PlateCarrier1_blk","V_PlateCarrier2_blk","V_BandollierB_oli", "V_Chestrig_oli", "V_TacVest_oli","V_TacVest_camo","V_SmershVest_01_F","V_SmershVest_01_radio_F","V_TacVestIR_blk","V_CarrierRigKBT_01_Olive_F","V_CarrierRigKBT_01_EAF_F","V_CarrierRigKBT_01_light_EAF_F","V_CarrierRigKBT_01_light_Olive_F"];
_militiaHvests append ["V_PlateCarrierIAGL_oli","V_CarrierRigKBT_01_light_EAF_F","V_CarrierRigKBT_01_light_Olive_F","V_CarrierRigKBT_01_heavy_EAF_F","V_CarrierRigKBT_01_heavy_Olive_F"];
_militiaMGvests append [];
_militiaMEDvests append [];
_militiaSLvests append [];
_militiaSNIvests append [];
_militiaGLvests append ["V_CarrierRigKBT_01_heavy_EAF_F","V_CarrierRigKBT_01_heavy_Olive_F"];
_militiaATvests append [];
_militiaENGvests append [];
_militiabackpacks append ["B_AssaultPack_eaf_F", "B_Carryall_eaf_F", "B_AssaultPack_rgr", "B_AssaultPack_sgg", "B_Kitbag_rgr", "B_Kitbag_sgg"];
_militiaATBackpacks append ["B_Carryall_eaf_F","B_Kitbag_rgr", "B_Kitbag_sgg"];
...
_militialongRangeRadios append ["B_RadioBag_01_eaf_F"];
_militiahelmets append ["H_MilCap_eaf","H_HelmetB_plain_wdl","H_HelmetB_light_wdl","H_HelmetHBK_headset_F", "H_HelmetHBK_F", "H_HelmetHBK_chops_F", "H_HelmetHBK_ear_F", "H_HelmetHBK_F","H_HelmetSpecB_wdl","H_HelmetAggressor_F","H_HelmetAggressor_cover_F","H_HelmetAggressor_cover_taiga_F"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append ["H_Beret_EAF_01_F"];
_militiaSNIhats append ["H_MilCap_eaf","H_Booniehat_eaf"];
