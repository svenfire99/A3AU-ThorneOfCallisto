/* Faction : UK
 * Converted from: CSA_AI_UK_Temperate.sqf
 */
...
_IFVs append ["csa38_valentineMkIIgreen", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Crocodile", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Howitzer", "LIB_Churchill_Mk7_AVRE"];
_airborneVehicles append ["LIB_UniversalCarrier"];
_tanks append ["LIB_M4A4_FIREFLY", "csa38_matildaii_1", "csa38_matildaiiCS_1"];
_lightTanks append ["csa38_valentineMkIIgreen"];
