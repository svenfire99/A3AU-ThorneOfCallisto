/* Faction : Wehrmacht
 * Converted from: CSA_AI_WEH_Temperate.sqf
 */
_basic append ["LIB_Kfz1"];
_lightUnarmed append ["LIB_Kfz1","LIB_Kfz1_camo","LIB_Kfz1_Hood"];
_lightArmed append ["LIB_Kfz1_MG42","LIB_Kfz1_MG42_camo","CSA38_8radLATE2","CSA38_8rad2LATE2"];
...
_lightAPCs append ["LIB_SdKfz251_FFV","LIB_SdKfz251"];
_APCs append ["LIB_SdKfz_7_AA", "LIB_SdKfz251_FFV","LIB_SdKfz251"];
_IFVs append ["LIB_PzKpfwIV_H", "LIB_StuG_III_G", "CSA38_pzIIID_LATE4", "CSA38_pzIVC_LATE2"];
_airborneVehicles append ["LIB_SdKfz251"];
_tanks append ["LIB_PzKpfwV", "LIB_PzKpfwVI_E"];
_lightTanks append ["CSA38_pzII_LATE2"];
...
_militiaLightArmed append ["LIB_Kfz1_MG42","LIB_Kfz1_MG42_camo"];
...
_traitorUniforms append ["U_LIB_GER_Soldier2"];
_traitorVests append ["V_LIB_GER_OfficerVest"];
_traitorHats append ["H_LIB_GER_Helmet"];
...
_sfuniforms append ["U_LIB_ST_Soldier_Camo","U_LIB_ST_Soldier_E44_Camo"];
...
_sfhelmets append ["H_LIB_ST_Helmet","H_LIB_GER_HelmetUtility_Oak"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append ["H_LIB_ST_Helmet"];
_sfSNIhats append ["H_LIB_ST_Helmet","H_LIB_GER_HelmetUtility_Oak"];
...
_eliteuniforms append ["U_LIB_GER_Soldier2","U_LIB_GER_Gefreiter"];
...
_militaryuniforms append ["U_LIB_GER_Soldier2","U_LIB_GER_Gefreiter"];
...
_militiauniforms append ["U_LIB_GER_Schutze","U_LIB_GER_Recruit"];
...
_militiahelmets append ["H_LIB_GER_Helmet", "H_LIB_GER_Cap"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append ["H_LIB_GER_Helmet"];
_militiaSNIhats append ["H_LIB_GER_Helmet", "H_LIB_GER_Cap"];
