/* Faction : UNSC
 * Converted from: OPTRE_AI_UNSC.sqf
 */
...
_militaryuniforms append ["OPTRE_FC_Marines_Uniform_BLK_L"];
_militaryENGuniforms append [];
_militarySLuniforms append ["OPTRE_FC_Marines_Uniform_BLK_L"];
_militaryvests append ["OPTRE_UNSC_M52A_Armor_Rifleman_MAR"];
_militaryHvests append [];
_militaryMGvests append ["OPTRE_UNSC_M52A_Armor_MG_MAR"];
_militaryMEDvests append ["OPTRE_UNSC_M52A_Armor_Corpsman_MAR"];
_militarySLvests append ["OPTRE_UNSC_M52A_Armor_TL_MAR"];
_militarySNIvests append [];
_militaryGLvests append ["OPTRE_UNSC_M52A_Armor_Grenadier_MAR"];
_militaryATvests append [];
_militaryENGvests append ["OPTRE_UNSC_M52A_Armor1_MAR"];
...
_militaryhelmets append ["OPTRE_UNSC_CH252_Helmet_MAR", "OPTRE_UNSC_CH252_Helmet2_MAR"];
...
_policehelmets append ["OPTRE_CPD_CH251P", "OPTRE_UNSC_CH252_Helmet_URB"];
...
_militiauniforms append ["OPTRE_FC_Marines_Uniform_L"];
...
_militiaSNIhats append ["OPTRE_FC_CH255_Helmet"];
...
_crewuniforms append ["OPTRE_UNSC_Navy_Uniform_Gray"];
_crewvests append ["OPTRE_UNSC_M52A_Armor3_MAR"];
_crewhelmets append ["OPTRE_UNSC_CH252_Helmet2_Vacuum_URB"];
...
_pilotuniforms append ["OPTRE_UNSC_Navy_Uniform_Gray"];
_pilotvests append ["OPTRE_UNSC_M52A_Armor2_URB"];
