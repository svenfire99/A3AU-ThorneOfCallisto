...
_fuelTrucks append [];
_medicalTrucks append ["CUP_B_nM997_NATO_T", "BRAF_Worker_Health"];
_lightAPCs append [];
_APCs append [];
_IFVs append [];
...
"WhiteHead_21"];
_voices append ["Male01ENGFRE","Male02ENGFRE","Male01FRE","Male02FRE","Male03FRE","CUP_D_Male01_GB_BAF","CUP_D_Male02_GB_BAF","CUP_D_Male03_GB_BAF","CUP_D_Male04_GB_BAF","CUP_D_Male05_GB_BAF"];
_sfVoices append [];
_eliteVoices append [];
