...
_faces append ["SSV_android_face_01","SSV_android_face_02","SSV_android_face_03","hal_synth_face_01"];
_voices append ["Male01ENGVR","Male01PERVR","Male01GREVR"];
_sfVoices append [];
_eliteVoices append [];
