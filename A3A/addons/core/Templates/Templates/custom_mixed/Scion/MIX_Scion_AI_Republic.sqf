/* Faction : Amalgamate Republic
 * Converted from: Scion_AI_Republic.sqf
 */
...
_lightAPCs append ["SCEXT_Gator_APC_AR"];
_APCs append ["SC_AR_IFV", "SCEXT_Gator_APC_AR"];
_IFVs append [];
_airborneVehicles append ["SC_AR_IFV"];
_tanks append ["SCEXT_Grizzly_AR", "SC_EXT_Rhino_AR"];
_lightTanks append ["SCEXT_Grizzly_AR", "SC_EXT_Rhino_AR"];
_aa append ["SC_Ferret_AA_AR"];
...
_planesCAS append ["SCR_TF3LInterceptor_AR"];
_planesAA append ["SCR_TF3LInterceptor_AR"];

_planesTransport append ["SC_ProwlerClassCorvette_VTOL"];
_gunship append [];
...
_militiaCars append ["SCEXT_Dingo_AR"];
_militiaAPCs append ["SCEXT_Gator_APC_AR"];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["SC_Helmet_SEN_SL_TV10_Black_VU"];
_SNIhats append ["SC_Helmet_WD_AV1_Urban_Light_V"];
...
_sfuniforms append ["SC_Undersuit_Black", "SC_Undersuit_Trojan"];
_sfMEDuniforms append [];
_sfENGuniforms append [];
_sfSLuniforms append [];
_sfvests append ["SC_Vest_SEN_Medium_Night"];
_sfHvests append [];
_sfMGvests append [];
_sfMEDvests append [];
_sfSLvests append [];
_sfSNIvests append [];
_sfGLvests append ["SC_Vest_SEN_Heavy_Night"];
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["SC_MercerJumppack_Black"];
...
_sfhelmets append ["SC_Helmet_SEN_Night", "SC_Helmet_SEN_Night_TV10"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append [];
_sfSNIhats append ["SC_Helmet_WD_Black_V"];
...
_eliteuniforms append ["SC_Warbot_Uniform"];
_eliteSLuniforms append [];
_elitevests append ["SC_WarfighterVest"];
_eliteHvests append [];
_eliteMGvests append [];
_eliteMEDvests append [];
_eliteSLvests append ["SC_WarfighterVest"];
_eliteSNIvests append [];
_eliteGLvests append ["SC_WarfighterVest"];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["SC_Backpack_Warbot"];
_eliteATBackpacks append ["SC_WarbotRocketRack"];
_eliteAABackpacks append [];
_eliteMGBackpacks append [];
_eliteGLBackpacks append [];
_eliteMEDBackpacks append [];
_eliteENGBackpacks append [];
_eliteEXPBackpacks append ["SC_WarbotJumppack"];
_eliteSLBackpacks append [];
_elitelongRangeRadios append [];
_elitehelmets append ["SC_EliminatorHead", "SC_Gen2WarbotHead_NoFS"];
...
_militaryvests append ["SC_Vest_WD_Medium_Urban", "SC_Vest_WD_Light_Urban"];
_militaryHvests append [];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append ["SC_Vest_WD_Heavy_Black"];
_militarySNIvests append [];
_militaryGLvests append ["SC_Vest_WD_Heavy_Urban"];
_militaryATvests append [];
_militaryENGvests append [];
_militarybackpacks append ["SC_Backpack_WD_Urban"];
_militaryATBackpacks append ["SC_Backpack_WD_Urban"];
_militaryAABackpacks append [];
_militaryMGBackpacks append [];
_militaryGLBackpacks append [];
_militaryMEDBackpacks append [];
_militaryENGBackpacks append [];
_militaryEXPBackpacks append ["SC_Backpack_WD_Urban"];
_militarySLBackpacks append [];
_militarylongRangeRadios append [];
_militaryhelmets append ["SC_MDF_Pathfinder_Helmet", "SC_Helmet_WD_Urban_V", "SC_Helmet_EN_Urban"];
...
_policevests append ["SC_Vest_WD_Medium_Guard", "SC_Vest_WD_Light_Guard"];
_policehelmets append ["SC_Beret_AR", "SC_Beret_AR_v2"];
...
_militiavests append ["SC_Vest_WD_Light_Urban"];
_militiaHvests append [];
_militiaMGvests append ["SC_Vest_WD_Heavy_Urban"];
_militiaMEDvests append [];
_militiaSLvests append ["SC_Vest_WD_Medium_Urban"];
_militiaSNIvests append [];
_militiaGLvests append ["SC_Vest_WD_Heavy_Urban"];
_militiaATvests append ["SC_Vest_WD_Heavy_Urban"];
_militiaENGvests append [];
_militiabackpacks append ["SC_Backpack_WD_Urban"];
_militiaATBackpacks append ["SC_SentinelPack_Black"];
...
_militiahelmets append ["SC_MilTac_Urban"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append ["SC_Beret_AR_v2"];
_militiaSNIhats append ["SC_Beret_AR"];
...
_crewvests append ["SC_Vest_WD_Basic_Guard", "SC_Vest_WD_Medium_Guard"];
_crewhelmets append ["SC_Helmet_WD_Guard_Light_V"];
...
_pilotvests append ["SC_Vest_WD_Light_Guard"];
_pilotbackpacks append [];
_pilothelmets append ["SC_Helmet_SKY_White"];
