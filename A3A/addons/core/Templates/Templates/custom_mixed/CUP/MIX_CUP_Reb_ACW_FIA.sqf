...
_fuelTrucks append [];
_medicalTrucks append ["C_Van_02_medevac_F"];
_lightAPCs append [];
_APCs append [];
_IFVs append [];
...
_tanks append [];
_lightTanks append [];
_aa append ["Flex_CUP_FIA_Hilux_zu23", "Flex_CUP_FIA_Hilux_armored_zu23"];
...
_staticMG append ["Flex_CUP_FIA_HMG_high"];
_staticAT append ["Flex_CUP_FIA_Metis", "Flex_CUP_FIA_SPG9"];
_staticAA append ["Flex_CUP_FIA_ZU23"];
_staticMortars append ["Flex_CUP_FIA_L16A2"];
_howitzers append [];
_radar append [];
_SAM append [];
