...
_fuelTrucks append [];
_medicalTrucks append ["a3a_Van_02_black_medevac_F"];
_lightAPCs append [];
_APCs append [];
_IFVs append [];
...
_tanks append [];
_lightTanks append [];
_aa append ["CUP_I_Hilux_zu23_TK"];
...
_staticMG append ["Flex_CUP_RAV_DSHKM", "Flex_CUP_RAV_KORD_high"];
_staticAT append ["Flex_CUP_RAV_Kornet", "Flex_CUP_RAV_Metis", "Flex_CUP_RAV_SPG9"];
_staticAA append [];
_staticMortars append ["Flex_CUP_RAV_2b14_82mm"];
_howitzers append [];
_radar append [];
_SAM append [];
