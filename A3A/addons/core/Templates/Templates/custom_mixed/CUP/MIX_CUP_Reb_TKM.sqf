/* Faction : TKM
 * Converted from: CUP_Reb_TKM.sqf
 */
_basic append ["I_Quadbike_01_F"];
_unarmedVehicles append ["CUP_I_Hilux_armored_unarmed_NAPA"];
_armedVehicles append ["CUP_I_Hilux_DSHKM_NAPA"];
_Trucks append [];
_cargoTrucks append [];
_ammoTrucks append [];
_repairTrucks append [];
_fuelTrucks append [];
_medicalTrucks append ["CUP_I_LR_Ambulance_RACS"];
_lightAPCs append [];
_APCs append [];
_IFVs append [];
...
_staticMG append ["CUP_I_DSHKM_NAPA"];
