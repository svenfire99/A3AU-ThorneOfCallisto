...
_tanks append [];
_lightTanks append [];
_aa append ["Flex_CUP_LUF_Hilux_zu23", "Flex_CUP_LUF_Hilux_armored_zu23"];
...
_staticMG append ["Flex_CUP_LUF_DSHKM", "Flex_CUP_LUF_HMG_high"];
_staticAT append ["Flex_CUP_LUF_SPG9"];
_staticAA append ["Flex_CUP_LUF_ZU23"];
_staticMortars append ["Flex_CUP_LUF_L16A2"];
_howitzers append [];
_radar append [];
_SAM append [];
