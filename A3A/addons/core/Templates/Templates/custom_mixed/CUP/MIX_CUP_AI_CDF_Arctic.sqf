...
_traitorUniforms append ["CUP_U_B_CDF_SNW_1"];
_traitorVests append ["CUP_V_CDF_6B3_1_SNW"];
_traitorHats append ["CUP_H_CDF_H_PASGT_SNW"];

_officerUniforms append ["CUP_U_B_CDF_SNW_2"];
_officerVests append ["CUP_V_CDF_OfficerBelt"];
_officerHats append ["CUP_H_CDF_OfficerCap_SNW"];
...
_uniforms append ["CUP_U_B_CDF_SNW_1", "CUP_U_B_CDF_SNW_2"];
_SLuniforms append [];
_ENGuniforms append [];
_MEDuniforms append [];
_MGvests append [];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["CUP_H_CDF_OfficerCap_SNW"];
_SNIhats append ["CUP_H_PMC_Cap_EP_Grey"];
