/* Faction : AFRF
 * Converted from: CUP_AI_AFRF_Arctic.sqf
 */
...
_uniforms append ["CUP_U_O_RUS_Ratnik_Winter"];
_SLuniforms append [];
_ENGuniforms append [];
_MEDuniforms append [];
_MGvests append [];
...
_ENGvests append [];
_vests append [];
_backpacks append ["CUP_O_RUS_Patrol_bag_Winter"];
_ATBackpacks append ["CUP_B_RPGPack_Khaki"];
_AABackpacks append [];
_MGBackpacks append [];
_GLBackpacks append [];
...
_SNIhats append ["CUP_H_PMC_Beanie_Headphones_Winter"];
...
_sfSNIhats append ["CUP_H_RUS_Balaclava_Ratnik_Headphones_winter", "CUP_H_RUS_Balaclava_Ratnik_Headphones_winter_v2"];
...
_militaryvests append ["CUP_Vest_RUS_6B45_Sh117", "CUP_Vest_RUS_6B45_Sh117_PKP", "CUP_Vest_RUS_6B45_Sh117_PKP_Del"];
...
_militaryhelmets append ["CUP_H_RUS_6B47_v2_Winter", "CUP_H_RUS_6B47_v2_GogglesClosed_Winter", "CUP_H_RUS_6B47_v2_GogglesDown_Winter", "CUP_H_RUS_6B47_v2_GogglesUp_Winter"];
...
_militiavests append ["V_Chestrig_rgr", "V_Chestrig_blk"];
...
_militiahelmets append ["CUP_H_SLA_Helmet_URB", "CUP_H_SLA_Helmet_URB_worn"];
...
_crewvests append ["CUP_Vest_RUS_6B45_Sh117"];
