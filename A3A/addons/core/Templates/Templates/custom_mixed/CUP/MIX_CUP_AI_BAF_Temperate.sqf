/* Faction : BAF
 * Converted from: CUP_AI_BAF_Temperate.sqf
 */
_basic append ["B_Quadbike_01_F"];
_unarmedVehicles append ["CUP_B_LR_Transport_GB_W"];
_armedVehicles append ["CUP_B_BAF_Coyote_GMG_W", "CUP_B_BAF_Coyote_L2A1_W", "CUP_B_Jackal2_L2A1_GB_W", "CUP_B_LR_Special_M2_GB_W", "CUP_B_LR_MG_GB_W", "CUP_B_Ridgback_GMG_GB_W", "CUP_B_Ridgback_HMG_GB_W", "CUP_B_Ridgback_LMG_GB_W", "CUP_B_Wolfhound_GMG_GB_W", "CUP_B_Wolfhound_HMG_GB_W", "CUP_B_Wolfhound_LMG_GB_W"];
_Trucks append ["CUP_B_MTVR_BAF_WOOD"];
_cargoTrucks append [];
...
_medicalTrucks append ["CUP_B_LR_Ambulance_GB_W"];
_lightAPCs append ["CUP_B_Mastiff_HMG_GB_W", "CUP_B_Mastiff_LMG_GB_W", "CUP_B_Mastiff_GMG_GB_W""CUP_B_FV432_Bulldog_GB_W", "CUP_B_FV432_Bulldog_GB_W"];
_APCs append ["CUP_B_FV432_Bulldog_GB_W_RWS", "CUP_B_FV432_Bulldog_GB_W_RWS", "CUP_B_FV510_GB_W", "CUP_B_MCV80_GB_W"];
_IFVs append ["CUP_B_FV510_GB_W", "CUP_B_MCV80_GB_W", "CUP_B_FV510_GB_W_SLAT", "CUP_B_MCV80_GB_W_SLAT"];
_airborneVehicles append ["CUP_B_Mastiff_HMG_GB_W", "CUP_B_Mastiff_LMG_GB_W", "CUP_B_Mastiff_GMG_GB_W", "CUP_B_FV432_Bulldog_GB_W", "CUP_B_FV432_Bulldog_GB_W"];
_tanks append ["CUP_B_Challenger2_Woodland_BAF"];
_lightTanks append ["CUP_B_FV510_GB_W", "CUP_B_MCV80_GB_W", "CUP_B_FV510_GB_W_SLAT", "CUP_B_MCV80_GB_W_SLAT"];
_aa append ["CUP_B_M6LineBacker_USA_W", "CUP_B_M163_Vulcan_USA"];
...
_helisLightAttack append ["CUP_B_AW159_GB"];
...
_militiaCars append ["CUP_B_LR_Transport_GB_W"];
_militiaAPCs append ["CUP_B_Mastiff_GMG_GB_W", "CUP_B_FV432_Bulldog_GB_W_RWS"];
...
_militaryuniforms append ["CUP_U_B_BAF_DPM_UBACSLONGKNEE", "CUP_U_B_BAF_DPM_UBACSLONGKNEE_Gloves", "CUP_U_B_BAF_DPM_UBACSROLLED_Gloves", "CUP_U_B_BAF_DPM_UBACSROLLEDKNEE"];
_militaryENGuniforms append [];
_militarySLuniforms append ["CUP_U_B_BAF_DPM_UBACSROLLED"];
_militaryvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Rifleman"];
_militaryHvests append [];
_militaryMGvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_AutomaticRifleman"];
_militaryMEDvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Medic"];
_militarySLvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Officer"];
_militarySNIvests append [];
_militaryGLvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Grenadier"];
_militaryATvests append [];
_militaryENGvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Engineer"];
_militarybackpacks append ["B_Carryall_khk"];
...
_militarySNIhats append ["CUP_H_FR_PRR_BoonieWDL"];
...
_militiauniforms append ["CUP_U_B_BAF_DPM_UBACSROLLED_Gloves", "CUP_U_B_BAF_DPM_UBACSLONGKNEE", "CUP_U_B_BAF_DPM_UBACSROLLED"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append [];
_militiavests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Rifleman"];
_militiaHvests append [];
_militiaMGvests append [];
_militiaMEDvests append [];
_militiaSLvests append [];
_militiaSNIvests append ["CUP_V_B_BAF_DPM_Osprey_Mk3_Scout"];
_militiaGLvests append [];
_militiaATvests append [];
_militiaENGvests append [];
_militiabackpacks append ["B_Carryall_khk"];
_militiaATBackpacks append ["CUP_B_Bergen_BAF"];
...
_militiahelmets append ["CUP_H_BAF_DPM_Mk6_EMPTY"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append [];
_militiaSNIhats append ["CUP_H_FR_PRR_BoonieWDL"];
