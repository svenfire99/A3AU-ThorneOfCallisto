...
_repairTrucks append ["CUP_B_MTVR_Repair_HIL", "CUP_B_nM1038_Repair_DF_USA_WDL", "CUP_B_nM1038_Repair_USA_WDL"];
_fuelTrucks append ["CUP_B_MTVR_Refuel_HIL"];
_medicalTrucks append ["CUP_B_nM997_DF_USA_WDL", "CUP_B_nM997_USA_WDL", "CUP_B_M1133_MEV_Woodland"];
_lightAPCs append ["CUP_B_M113A3_USA", "CUP_B_M113A3_USA", "CUP_B_RG31E_M2_OD_USA", "CUP_B_RG31_M2_OD_USA"];
_APCs append ["CUP_B_Boxer_HMG_HIL", "CUP_B_Boxer_GMG_HIL", "CUP_B_M2Bradley_USA_W", "CUP_B_M7Bradley_USA_W"];
_IFVs append ["CUP_B_M2Bradley_USA_W", "CUP_B_M7Bradley_USA_W", "CUP_B_M2A3Bradley_USA_W", "CUP_B_M2A3Bradley_USA_W"];
_airborneVehicles append ["CUP_B_M113A3_USA", "CUP_B_M113A3_USA", "CUP_B_RG31E_M2_OD_USA", "CUP_B_RG31_M2_OD_USA"];
_tanks append ["CUP_B_Leopard2A6_HIL"];
...
_helisLight append ["CUP_B_AW159_Unarmed_HIL", "CUP_B_MH6M_USA"];
_transportHelicopters append ["CUP_B_AW159_Unarmed_HIL","CUP_B_CH47F_HIL","CUP_B_412_Mil_Transport_HIL"];
_helisLightAttack append ["CUP_B_AW159_HIL","CUP_B_412_Military_Armed_AT_HIL","CUP_B_412_Military_Armed_HIL","CUP_B_412_dynamicLoadout_HIL"];
_helisAttack append ["CUP_B_AH1Z_Dynamic_USMC"];
_airPatrol append [];

_artillery append ["CUP_B_M270_HE_HIL", "CUP_B_M270_DPICM_HIL"];
...
_militiaTrucks append ["CUP_B_MTVR_BAF_WOOD"];
_militiaCars append ["CUP_B_nM1025_Unarmed_USMC_WDL"];
_militiaAPCs append ["CUP_B_M113A3_USA", "CUP_B_M113A3_USA"];
...
_faces append ["AfricanHead_01","AfricanHead_02","AfricanHead_03","AsianHead_A3_01","AsianHead_A3_02",
...
_sfradios append [];
_sfgpses append [];
_sfNVGs append ["CUP_NVG_GPNVG_green"];
_sfbinoculars append ["CUP_LRTV"];
_sfrangefinders append [];

_sfuniforms append ["CUP_U_B_HIL_ACU_Gloves_TTS", "CUP_U_B_HIL_ACU_Kneepad_Gloves_TTS", "CUP_U_B_HIL_ACU_Kneepad_Rolled_Gloves_TTS", "CUP_U_B_HIL_ACU_Kneepad_Rolled_TTS",
"CUP_U_B_HIL_ACU_Kneepad_TTS","CUP_U_B_HIL_ACU_Rolled_Gloves_TTS","CUP_U_B_HIL_ACU_Rolled_TTS","CUP_U_B_HIL_ACU_TTS"
];
_sfMEDuniforms append [];
_sfENGuniforms append [];
_sfSLuniforms append [];
_sfvests append ["CUP_V_PMC_CIRAS_OD_Patrol", "CUP_V_MBSS_PACA_Green"];
_sfHvests append [];
_sfMGvests append [];
_sfMEDvests append [];
_sfSLvests append ["CUP_V_PMC_CIRAS_OD_TL"];
_sfSNIvests append [];
...
_sfhelmets append ["CUP_H_OpsCore_Covered_Tigerstripe", "CUP_H_OpsCore_Covered_Tigerstripe_NoHS", "CUP_H_OpsCore_Covered_Tigerstripe_SF", "H_Cap_oli_hs", "H_Cap_headphones"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append [];
_sfSNIhats append ["CUP_H_Booniehat_TTS"];

_sfglasses append ["CUP_G_ESS_BLK_Facewrap_Black", "CUP_G_ESS_RGR_Facewrap_Tropical", "CUP_G_ESS_BLK_Scarf_White",
...
_eliteuniforms append ["CUP_U_B_HIL_ACU_CCE", "CUP_U_B_HIL_ACU_Gloves_CCE", "CUP_U_B_HIL_ACU_Kneepad_CCE", "CUP_U_B_HIL_ACU_Kneepad_Gloves_CCE",
...
_elitevests append ["CUP_V_PMC_CIRAS_OD_Patrol"];
_eliteHvests append [];
_eliteMGvests append ["CUP_V_PMC_CIRAS_OD_Grenadier"];
...
_elitebackpacks append ["CUP_B_TacticalPack_CCE"];
_eliteATBackpacks append ["CUP_B_TacticalPack_CCE"];
...
_elitehelmets append ["CUP_H_HIL_HelmetACH_CCE", "CUP_H_HIL_HelmetACH_GCovered_CCE", "CUP_H_HIL_HelmetACH_GCovered_Headset_CCE", "CUP_H_HIL_HelmetACH_ESS_CCE", "CUP_H_HIL_HelmetACH_ESS_Headset_CCE"];
...
_militaryuniforms append ["CUP_U_B_HIL_ACU_CCE", "CUP_U_B_HIL_ACU_Gloves_CCE", "CUP_U_B_HIL_ACU_Kneepad_CCE", "CUP_U_B_HIL_ACU_Kneepad_Gloves_CCE",
"CUP_U_B_HIL_ACU_Kneepad_Rolled_CCE","CUP_U_B_HIL_ACU_Kneepad_Rolled_Gloves_CCE","CUP_U_B_HIL_ACU_Rolled_CCE","CUP_U_B_HIL_ACU_Rolled_Gloves_CCE"
];
_militaryENGuniforms append [];
_militarySLuniforms append [];
_militaryvests append ["CUP_V_PMC_CIRAS_OD_Patrol"];
...
_militaryhelmets append ["CUP_H_HIL_HelmetACH_CCE", "CUP_H_HIL_HelmetACH_GCovered_CCE", "CUP_H_HIL_HelmetACH_GCovered_Headset_CCE", "CUP_H_HIL_HelmetACH_ESS_CCE", "CUP_H_HIL_HelmetACH_ESS_Headset_CCE"];
...
_militiauniforms append ["CUP_U_B_BDUv2_OD", "CUP_U_B_BDUv2_dirty_OD", "CUP_U_B_BDUv2_gloves_OD", "CUP_U_B_BDUv2_gloves_dirty_OD",
...
_militiavests append ["CUP_V_I_RACS_Carrier_Rig_wdl_2", "CUP_V_I_RACS_Carrier_Rig_wdl_3", "CUP_V_B_PASGT_CCE"];
...
_militiahelmets append ["CUP_H_US_patrol_cap_OD", "CUP_H_Ger_M92"];
...
_crewhelmets append ["CUP_H_USMC_Crew_Helmet"];
...
_pilothelmets append ["CUP_H_SPH4_green"];
