...
_fuelTrucks append [];
_medicalTrucks append ["CUP_C_S1203_Ambulance_CIV"];
_lightAPCs append [];
_APCs append [];
_IFVs append [];
...
_tanks append [];
_lightTanks append [];
_aa append ["CUP_I_Ural_ZU23_NAPA", "CUP_I_Hilux_zu23_NAPA"];
...
_staticMG append ["I_E_HMG_02_high_F"];
_staticAT append ["CUP_I_SPG9_NAPA"];
_staticAA append ["CUP_I_ZU23_NAPA"];
_staticMortars append ["CUP_I_2b14_82mm_NAPA"];
_howitzers append [];
_radar append [];
_SAM append [];
...
_faces append ["WhiteHead_30","WhiteHead_15","WhiteHead_14"];
_voices append ["CUP_D_Male01_GB_PMC","CUP_D_Male02_GB_PMC","CUP_D_Male03_GB_PMC","CUP_D_Male04_GB_PMC","CUP_D_Male05_GB_PMC"];
_sfVoices append [];
_eliteVoices append [];
