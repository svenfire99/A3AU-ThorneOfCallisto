...
_lightUnarmed append ["CUP_B_UAZ_Open_ACR", "CUP_B_UAZ_Unarmed_ACR", "CUP_B_LR_Transport_CZ_W"];
_lightArmed append ["CUP_B_HMMWV_AGS_GPK_ACR", "CUP_B_HMMWV_DSHKM_GPK_ACR", "CUP_B_HMMWV_M2_GPK_ACR", "CUP_B_LR_Special_Des_CZ_D", "CUP_B_UAZ_SPG9_ACR", "CUP_B_UAZ_METIS_ACR", "CUP_B_UAZ_MG_ACR", "CUP_B_UAZ_AGS30_ACR", "CUP_B_Dingo_CZ_Wdl", "CUP_B_Dingo_GL_CZ_Wdl"];
...
_traitorUniforms append ["CUP_U_B_CZ_WDL_NoKneepads"];
_traitorVests append ["V_Rangemaster_belt"];
_traitorHats append ["CUP_H_CZ_Hat01"];

_officerUniforms append ["CUP_U_B_CZ_WDL_NoKneepads"];
