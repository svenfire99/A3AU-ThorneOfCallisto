...
_repairTrucks append ["CUP_I_nM1038_Repair_ION"];
_fuelTrucks append ["CUP_B_MTVR_Refuel_USA"];
_medicalTrucks append ["CUP_I_nM1035_amb_ION"];
_lightAPCs append ["CUP_I_RG31_Mk19_ION", "CUP_I_RG31E_M2_ION", "CUP_I_RG31_M2_ION", "CUP_I_RG31_M2_GC_ION"];
_APCs append ["CUP_I_BTR80A_ION", "CUP_I_BTR80_ION", "CUP_B_FV432_Bulldog_GB_D_RWS"];
_IFVs append ["CUP_B_FV510_GB_D_SLAT"];
_airborneVehicles append ["CUP_I_RG31_Mk19_ION", "CUP_I_RG31E_M2_ION", "CUP_I_RG31_M2_ION", "CUP_I_RG31_M2_GC_ION"];
_tanks append ["CUP_B_Challenger2_Desert_BAF"];
_lightTanks append ["CUP_B_FV510_GB_D_SLAT"];
_aa append ["CUP_I_M163_Vulcan_RACS"];
...
_militiaAPCs append ["CUP_I_RG31_Mk19_ION", "CUP_I_RG31E_M2_ION", "CUP_I_RG31_M2_ION", "CUP_I_RG31_M2_GC_ION"];
...
_sfuniforms append ["CUP_I_B_PMC_Unit_11", "CUP_I_B_PMC_Unit_20", "CUP_I_B_PMC_Unit_42"];
_sfMEDuniforms append [];
_sfENGuniforms append [];
_sfSLuniforms append [];
_sfvests append ["CUP_V_PMC_CIRAS_Black_TL"];
_sfHvests append [];
_sfMGvests append ["CUP_V_B_Armatus_BB_Black"];
_sfMEDvests append ["CUP_V_B_Armatus_Black"];
_sfSLvests append [];
_sfSNIvests append [];
_sfGLvests append ["CUP_V_PMC_CIRAS_Black_Grenadier"];
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["B_AssaultPack_blk"];
...
_eliteuniforms append ["CUP_I_B_PMC_Unit_9", "CUP_I_B_PMC_Unit_40", "CUP_I_B_PMC_Unit_43"];
_eliteSLuniforms append [];
_elitevests append ["CUP_V_CPC_Fastbelt_coy"];
_eliteHvests append [];
_eliteMGvests append ["CUP_V_CPC_weaponsbelt_coy"];
_eliteMEDvests append [];
_eliteSLvests append ["CUP_V_CPC_tlbelt_coy"];
_eliteSNIvests append [];
_eliteGLvests append ["CUP_V_CPC_weapons_coy"];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["CUP_B_AssaultPack_Coyote"];
_eliteATBackpacks append ["CUP_B_USPack_Coyote"];
...
_elitehelmets append ["CUP_H_OpsCore_Tan_SF"];
_eliteMEDhelmets append [];
_eliteSLhelmets append [];
_eliteSLhats append ["CUP_H_PMC_Cap_PRR_Grey"];
...
_militaryuniforms append ["CUP_I_B_PMC_Unit_9", "CUP_I_B_PMC_Unit_40", "CUP_I_B_PMC_Unit_43"];
_militaryENGuniforms append [];
_militarySLuniforms append ["CUP_I_B_PMC_Unit_21"];
_militaryvests append ["CUP_V_CPC_Fastbelt_coy"];
_militaryHvests append [];
_militaryMGvests append ["CUP_V_CPC_weaponsbelt_coy"];
_militaryMEDvests append ["CUP_V_CPC_medicalbelt_coy"];
_militarySLvests append ["CUP_V_CPC_tlbelt_coy"];
_militarySNIvests append [];
_militaryGLvests append ["CUP_V_CPC_weapons_coy"];
_militaryATvests append [];
_militaryENGvests append ["CUP_V_CPC_Fast_coy"];
_militarybackpacks append ["CUP_B_AssaultPack_Coyote"];
...
_militarySLBackpacks append ["CUP_B_USPack_Coyote"];
_militarylongRangeRadios append [];
_militaryhelmets append ["CUP_H_OpsCore_Tan_SF"];
_militaryMEDhelmets append [];
_militarySLhelmets append [];
_militarySLhats append [];
_militarySNIhats append ["CUP_H_PMC_Cap_PRR_Grey"];
...
_militiauniforms append ["CUP_I_B_PMC_Unit_40", "CUP_I_B_PMC_Unit_39", "CUP_I_B_PMC_Unit_38", "CUP_I_B_PMC_Unit_1", "CUP_I_B_PMC_Unit_21"];
