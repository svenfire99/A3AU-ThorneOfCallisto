/* Faction : USMC
 * Converted from: CUP_AI_US_Marine_Arid.sqf
 */
_basic append ["B_Quadbike_01_F"];
_unarmedVehicles append ["CUP_B_nM1025_Unarmed_USMC_DES", "CUP_B_nM1025_Unarmed_DF_USMC_DES", "CUP_B_nM1038_DF_USMC_DES", "CUP_B_nM1038_USMC_DES", "CUP_B_nM1038_4s_USMC_DES", "CUP_B_nM1038_4s_DF_USMC_DES", "CUP_B_M1151_DSRT_USMC", "CUP_B_M1152_DSRT_USMC"];
_armedVehicles append ["CUP_B_nM1025_M2_USMC_DES", "CUP_B_nM1025_M2_DF_USMC_DES", "CUP_B_nM1025_M240_USMC_DES", "CUP_B_nM1025_M240_DF_USMC_DES", "CUP_B_nM1025_Mk19_USMC_DES", "CUP_B_nM1025_Mk19_DF_USMC_DES", "CUP_B_nM1025_SOV_M2_USMC_DES", "CUP_B_nM1025_SOV_Mk19_USMC_DES", "CUP_B_nM1036_TOW_USMC_DES", "CUP_B_nM1036_TOW_DF_USMC_DES", "CUP_B_M1151_M2_DSRT_USMC", "CUP_B_M1151_Deploy_DSRT_USMC", "CUP_B_M1151_Mk19_DSRT_USMC", "CUP_B_M1165_GMV_DSRT_USMC", "CUP_B_M1167_DSRT_USMC"];
_Trucks append ["CUP_B_MTVR_USMC"];
_cargoTrucks append ["B_Truck_01_flatbed_F"];
_ammoTrucks append ["CUP_B_nM1038_Ammo_USMC_DES", "CUP_B_nM1038_Ammo_DF_USMC_DES", "CUP_B_MTVR_Ammo_USMC"];
_repairTrucks append ["CUP_B_MTVR_Repair_USMC", "CUP_B_nM1038_Repair_USMC_DES", "CUP_B_nM1038_Repair_DF_USMC_DES"];
_fuelTrucks append ["CUP_B_MTVR_Refuel_USMC"];
_medicalTrucks append ["CUP_B_nM997_DF_USMC_DES", "CUP_B_nM997_USMC_DES"];
_lightAPCs append ["CUP_B_M113A3_desert_USA", "CUP_B_M113A3_desert_USA", "CUP_B_RG31E_M2_USMC", "CUP_B_RG31_Mk19_USMC",  "CUP_B_RG31_M2_USMC", "CUP_B_RG31_M2_GC_USMC"];
_APCs append ["CUP_B_AAV_USMC", "CUP_B_AAV_USMC_TTS", "CUP_B_LAV25_desert_USMC", "CUP_B_LAV25M240_desert_USMC"];
_IFVs append [];
_airborneVehicles append ["CUP_B_M113A3_desert_USA", "CUP_B_M113A3_desert_USA"];
_tanks append ["CUP_B_M1A1FEP_Desert_USMC", "CUP_B_M1A1FEP_TUSK_Desert_USMC"];
_lightTanks append ["CUP_B_LAV25_desert_USMC", "CUP_B_LAV25M240_desert_USMC"];
_aa append ["CUP_B_nM1097_AVENGER_USMC_DES"];
...
_Amphibious append ["CUP_B_AAV_USMC", "CUP_B_AAV_USMC_TTS", "CUP_B_LAV25_desert_USMC", "CUP_B_LAV25M240_desert_USMC"];
...
_helisLight append ["CUP_B_MH6M_USA", "CUP_B_MH6J_USA", "CUP_B_UH1Y_UNA_USMC"];
_transportHelicopters append ["CUP_MH60S_Unarmed_USN", "CUP_MH60S_Unarmed_FFV_USN", "CUP_B_MH60S_USMC", "CUP_B_UH60S_USN", "CUP_B_CH53E_USMC", "CUP_B_MH60L_DAP_2x_USN"];
_helisLightAttack append ["CUP_B_MH60L_DAP_4x_USN", "CUP_B_UH1Y_Gunship_Dynamic_USMC"];
...
_militiaLightArmed append ["CUP_B_nM1025_M2_USA_DES"];
_militiaTrucks append ["CUP_B_MTVR_USA"];
_militiaCars append ["CUP_B_nM1025_Unarmed_USA_DES"];
_militiaAPCs append ["CUP_B_M113A3_desert_USA"];
...
_sfuniforms append ["CUP_U_B_USMC_FROG1_DMARPAT", "CUP_U_B_USMC_FROG2_DMARPAT", "CUP_U_B_USMC_FROG3_DMARPAT", "CUP_U_B_USMC_FROG4_DMARPAT"];
_sfMEDuniforms append [];
_sfENGuniforms append [];
_sfSLuniforms append [];
_sfvests append ["CUP_V_B_RRV_DA1"];
_sfHvests append [];
_sfMGvests append ["CUP_V_CPC_weaponsbelt_mc"];
_sfMEDvests append ["CUP_V_CPC_medicalbelt_coy"];
_sfSLvests append [];
_sfSNIvests append [];
_sfGLvests append ["CUP_V_PMC_CIRAS_Coyote_Grenadier"];
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["B_AssaultPack_cbr", "B_Carryall_cbr", "CUP_B_AssaultPack_Coyote"];
_sfATBackpacks append ["CUP_B_USPack_Coyote"];
...
_sfhelmets append ["CUP_H_OpsCore_Tan_SF", "CUP_H_USArmy_ECH_MARPAT_des"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append ["CUP_H_USA_Cap_MARSOC_DEF"];
_sfSNIhats append [];
...
_eliteuniforms append ["CUP_U_B_USMC_MCCUU_des_gloves", "CUP_U_B_USMC_MCCUU_des_roll_2", "CUP_U_B_USMC_MCCUU_des_roll_2_gloves", "CUP_U_B_USMC_MCCUU_des_roll_2_pads_gloves", "CUP_U_B_USMC_MCCUU_des_roll_pads_gloves", "CUP_U_B_USMC_MCCUU_des_roll_pads", "CUP_U_B_USMC_MCCUU_des_roll_gloves", "CUP_U_B_USMC_MCCUU_des_roll"];
_eliteSLuniforms append [];
_elitevests append ["CUP_V_B_Eagle_SPC_Rifleman"];
_eliteHvests append [];
_eliteMGvests append ["CUP_V_B_Eagle_SPC_MG"];
_eliteMEDvests append [];
_eliteSLvests append ["CUP_V_B_Eagle_SPC_Officer"];
_eliteSNIvests append [];
_eliteGLvests append ["CUP_V_B_Eagle_SPC_GL"];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["B_AssaultPack_rgr"];
_eliteATBackpacks append ["CUP_B_USMC_MOLLE"];
...
_elitehelmets append ["CUP_H_LWHv2_MARPAT_des", "CUP_H_LWHv2_MARPAT_des_comms", "CUP_H_USArmy_ECH_MARPAT_des", "CUP_H_USArmy_ECH_GCOVERED_Headset_MARPAT_des"];
_eliteMEDhelmets append [];
_eliteSLhelmets append [];
_eliteSLhats append ["CUP_H_USMC_BOONIE_2_DES"];
...
_militaryuniforms append ["CUP_U_B_USMC_MCCUU_des_gloves", "CUP_U_B_USMC_MCCUU_des_roll_2", "CUP_U_B_USMC_MCCUU_des_roll_2_gloves", "CUP_U_B_USMC_MCCUU_des_roll_2_pads_gloves", "CUP_U_B_USMC_MCCUU_des_roll_pads_gloves", "CUP_U_B_USMC_MCCUU_des_roll_pads", "CUP_U_B_USMC_MCCUU_des_roll_gloves", "CUP_U_B_USMC_MCCUU_des_roll"];
_militaryENGuniforms append [];
_militarySLuniforms append ["CUP_U_B_USMC_MCCUU_des_roll_2"];
_militaryvests append ["CUP_V_B_Eagle_SPC_Rifleman"];
_militaryHvests append [];
_militaryMGvests append ["CUP_V_B_Eagle_SPC_MG"];
_militaryMEDvests append ["CUP_V_B_Eagle_SPC_Corpsman"];
_militarySLvests append ["CUP_V_B_Eagle_SPC_Officer"];
_militarySNIvests append [];
_militaryGLvests append ["CUP_V_B_Eagle_SPC_GL"];
_militaryATvests append [];
_militaryENGvests append ['CUP_V_B_Eagle_SPC_AT'];
_militarybackpacks append ["B_Carryall_cbr", "CUP_B_USPack_Coyote"];
_militaryATBackpacks append ["CUP_B_USPack_Coyote"];
...
_militaryhelmets append ["CUP_H_LWHv2_MARPAT_des", "CUP_H_LWHv2_MARPAT_des_comms", "CUP_H_USArmy_ECH_MARPAT_des", "CUP_H_USArmy_ECH_GCOVERED_Headset_MARPAT_des"];
...
_militiauniforms append ["CUP_U_B_USMC_MCCUU_des_gloves", "CUP_U_B_USMC_MCCUU_des_roll_2_gloves"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append [];
_militiavests append ["CUP_V_B_Eagle_SPC_Rifleman"];
_militiaHvests append [];
_militiaMGvests append [];
_militiaMEDvests append [];
_militiaSLvests append [];
_militiaSNIvests append ["CUP_V_B_Eagle_SPC_DMR"];
_militiaGLvests append [];
_militiaATvests append [];
_militiaENGvests append [];
_militiabackpacks append [ "B_AssaultPack_cbr"];
_militiaATBackpacks append ["CUP_B_USPack_Coyote"];
...
_militiaSLBackpacks append ["B_Kitbag_cbr"];
_militialongRangeRadios append [];
_militiahelmets append ["CUP_H_LWHv2_MARPAT_des"];
...
_crewuniforms append ["CUP_U_B_USMC_MCCUU_des_gloves"];
_crewvests append ["CUP_V_B_Eagle_SPC_Crew"];
_crewhelmets append ["CUP_H_CVCH_des"];
