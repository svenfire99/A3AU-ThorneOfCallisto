...
_traitorUniforms append ["Flex_CUP_FIN_Combat_Uniform_Tshirt"];
_traitorVests append ["V_Chestrig_rgr", "V_TacVest_oli"];
_traitorHats append ["H_Watchcap_camo", "Flex_CUP_FIN_Beret_Army", "Flex_CUP_FIN_Patrol_cap"];

_officerUniforms append ["Flex_CUP_FIN_Combat_Uniform_Gloves_Rolled", "Flex_CUP_FIN_Combat_Uniform_Pads_Rolled"];
_officerVests append ["Flex_CUP_FIN_V_CPC_tlbelt", "Flex_CUP_FIN_V_CPC_tl"];
_officerHats append ["Flex_CUP_FIN_Beret_Army"];
...
_SLBackpacks append [];
_longRangeRadios append ["Flex_CUP_FIN_RadioBag"];
_helmets append [];
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["Flex_CUP_FIN_Beret_Army"];
_SNIhats append ["Flex_CUP_FIN_Boonie_Wood"];
