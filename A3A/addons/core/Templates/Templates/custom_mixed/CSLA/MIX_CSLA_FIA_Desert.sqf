...
_tanks append [];
_lightTanks append [];
_aa append ["CSLA_FIA_PLdvK59V3S_des"];
...
_staticMG append ["CSLA_UK59L_Stat","FIA_DShKM_h_Stat","US85_M60E3_Stat_DES","US85_M60_Stat_DES"];
_staticAT append ["CSLA_9K113_Stat","FIA_AGS17_Stat"];
_staticAA append [];
