...
_traitorUniforms append ["TFC_CU_CombatUniform_tunic_cadpat_AR"];
_traitorVests append ["TFC_CV_SORD_Ballistic_AR", "TFC_CV_BV_AR"];
_traitorHats append ["TFC_CH_CG634_CADPAT_SCRIM_01_AR", "TFC_CH_CG634_CADPAT_SCRIM_L_01_AR"];

_officerUniforms append ["TFC_CU_CombatUniform_otw_cadpat_AR"];
...
_vests append [];
_backpacks append [];
_ATBackpacks append ["tfc_cb_Carryall_AR"];
_AABackpacks append [];
_MGBackpacks append [];
_GLBackpacks append [];
...
_SLBackpacks append [];
_longRangeRadios append ["TFC_CB_Smallpack_AR_TFAR"];
_helmets append [];
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["TFC_CH_CG634_HS_CADPAT_AR", "TFC_CH_CG634_CADPAT_GG_HS_AR"];
_SNIhats append ["TFC_CH_Booniehat_CADPAT_AR"];
