...
_traitorUniforms append ["U_mas_chi_O_wint"];
_traitorVests append ["V_mas_chi_PlateCarrier_w"];
_traitorHats append ["CUP_H_PMC_Beanie_Winter"];

_officerUniforms append ["U_mas_chi_O_soldw"];
_officerVests append ["V_mas_chi_PlateCarrier_w"];
