...
_repairTrucks       append ["UK3CB_CSAT_W_O_MAZ_543_Repair", "UK3CB_CSAT_W_O_Ural_Repair"];
_fuelTrucks         append ["UK3CB_CSAT_W_O_MAZ_543_Refuel", "UK3CB_CSAT_W_O_Ural_Fuel"];
_medicalTrucks      append ["UK3CB_CSAT_W_O_GAZ_Vodnik_MedEvac"];
_lightAPCs          append ["UK3CB_CSAT_W_O_GAZ_Vodnik_PKT", "UK3CB_CSAT_W_O_BRDM2_HQ", "UK3CB_CSAT_W_O_GAZ_Vodnik_Cannon", "UK3CB_CSAT_W_O_GAZ_Vodnik_HMG", "UK3CB_CSAT_W_O_GAZ_Vodnik_KVPT", "UK3CB_CSAT_W_O_BTR40_MG"];
_APCs               append ["UK3CB_CSAT_W_O_BTR80a", "UK3CB_CSAT_W_O_BTR80"];
_IFVs               append ["UK3CB_CSAT_W_O_BTR60", "UK3CB_CSAT_W_O_MTLB_PKT"];
_airborneVehicles   append ["UK3CB_CSAT_W_O_BRDM2_ATGM", "UK3CB_CSAT_W_O_BRDM2", "UK3CB_CSAT_W_O_BMP3", "UK3CB_CSAT_W_O_BMP3MERA", "UK3CB_CSAT_W_O_BRM1K", "UK3CB_CSAT_W_O_BMD2", "UK3CB_CSAT_W_O_BMD1K"];
_tanks              append ["UK3CB_CSAT_W_O_T80UK", "UK3CB_CSAT_W_O_T80U", "UK3CB_CSAT_W_O_T80BVK", "UK3CB_CSAT_W_O_T80BV"];
_lightTanks         append ["UK3CB_CSAT_W_O_T55", "UK3CB_CSAT_W_O_T72A", "UK3CB_CSAT_W_O_T72B", "UK3CB_CSAT_W_O_T72BC"];
_aa                 append ["UK3CB_CSAT_W_O_2S6M_Tunguska", "UK3CB_CSAT_W_O_ZsuTank"];

_SDV        append ["B_SDV_01_F"];
_DropPod    append ["SpaceshipCapsule_01_F"];

_transportBoat  append ["UK3CB_CSAT_W_O_Skiff"];
_gunBoat        append ["UK3CB_CSAT_W_O_Armed_Boat_HMG_Minigun"];
_Amphibious     append [];

_planesCAS  append ["UK3CB_CSAT_W_O_MIG21", "UK3CB_CSAT_W_O_MIG21_CAS", "UK3CB_CSAT_W_O_Su25SM_CAS"];
_planesAA   append ["UK3CB_CSAT_W_O_MIG21_AA", "UK3CB_CSAT_W_O_MIG29S", "UK3CB_CSAT_W_O_MIG29SM"];

_planesTransport    append ["RHS_TU95MS_vvs_old"];
_gunship            append [];

_helisLight             append ["UK3CB_CSAT_W_O_Bell412_Utility", "UK3CB_CSAT_W_O_Orca"];
_transportHelicopters   append ["UK3CB_CSAT_W_O_Mi_24V", "UK3CB_CSAT_W_O_Mi8"];
_helisLightAttack       append ["UK3CB_CSAT_W_O_Bell412_Armed", "UK3CB_CSAT_W_O_Bell412_Armed_AT", "UK3CB_CSAT_W_O_Orca_Armed_MULTI", "UK3CB_CSAT_W_O_Orca_Armed_AT"];
_helisAttack            append ["UK3CB_CSAT_W_O_Mi_24G", "UK3CB_CSAT_W_O_Mi8AMTSh", "UK3CB_CSAT_W_O_Orca_Armed_CAS"];
_airPatrol              append ["UK3CB_CSAT_W_O_Orca"];

_artillery      append ["UK3CB_CSAT_W_O_2S1", "UK3CB_CSAT_W_O_BM21"];
...
_uavsAttack     append ["UK3CB_CSAT_W_O_Ababil_CAS", "UK3CB_CSAT_W_O_Ababil_AT", "UK3CB_CSAT_W_O_Fenghuang"];
_uavsPortable   append ["UK3CB_CSAT_W_O_Darter"];

_militiaLightArmed  append ["UK3CB_CSAT_W_O_UAZ_MG", "UK3CB_CSAT_W_O_UAZ_SPG9"];
_militiaTrucks      append ["UK3CB_CSAT_W_O_Ural_Open", "UK3CB_CSAT_W_O_Ural"];
_militiaCars        append ["UK3CB_CSAT_W_O_UAZ_Open", "UK3CB_CSAT_W_O_UAZ_Closed"];
_militiaAPCs        append ["UK3CB_CSAT_W_O_MTLB_PKT", "UK3CB_CSAT_W_O_BTR60", "UK3CB_CSAT_W_O_BTR40_MG"]; 

_policeVehs append ["UK3CB_CSAT_W_O_Offroad_Unarmed", "UK3CB_CSAT_W_O_M1030"];

_staticMG       append ["UK3CB_CSAT_W_O_DSHKM", "UK3CB_CSAT_W_O_PKM_High", "UK3CB_CSAT_W_O_Searchlight"];
_staticAT       append ["UK3CB_CSAT_W_O_SPG9", "UK3CB_CSAT_W_O_Kornet"];
...
_faces append ["PersianHead_A3_01","PersianHead_A3_02","PersianHead_A3_03","AsianHead_A3_01","AsianHead_A3_02","AsianHead_A3_03","AsianHead_A3_04","AsianHead_A3_05"];
...
_traitorUniforms append ["UK3CB_CSAT_W_O_U_Officer", "UK3CB_CSAT_F_O_U_Officer"];
_traitorVests append ["UK3CB_TKA_I_V_6Sh92_Radio_Grey", "UK3CB_CSAT_W_O_V_Carrier_Rig"];
_traitorHats append ["UK3CB_CSAT_IRAN_H_Beret", "UK3CB_CSAT_CHI_H_Beret", "UK3CB_CSAT_ARG_H_Beret"];

_officerUniforms append ["UK3CB_CSAT_W_O_U_Officer", "UK3CB_CSAT_F_O_U_Officer"];
...
_longRangeRadios append ["UK3CB_CSAT_W_O_B_RadioBag"];
_helmets append [];
_slHat append ["UK3CB_CSAT_IRAN_H_Beret", "UK3CB_CSAT_CHI_H_Beret"];
_sniHats append ["UK3CB_CSAT_W_O_H_BoonieHat", "UK3CB_CSAT_W_O_H_BoonieHat_hs"];
...
_sfuniforms append ["UK3CB_CSAT_W_O_U_SF_CombatUniform_Ghillie"];
_sfslUniforms append [];
_sfvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Light", "UK3CB_CSAT_W_O_V_Carrier_Rig_Crew"];
_sfHvests append [];
_sfMGvests append [];
_sfMEDvests append [];
_sfSLvests append [];
_sfSNIvests append [];
_sfGLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_CQB_TAN", "UK3CB_CSAT_W_O_V_Carrier_Rig_Tactical_TAN", "UK3CB_CSAT_W_O_V_Carrier_Rig_Heavy"];
_sfbackpacks append ["UK3CB_CSAT_O_B_TACPACK_BRN", "UK3CB_CSAT_W_O_B_ASS", "UK3CB_CSAT_W_O_B_RIF"];
...
_sfhelmets append ["rhsusf_opscore_ut", "rhsusf_opscore_ut_pelt", "UK3CB_H_Ballistic_Mask_CSAT_W", "UK3CB_CSAT_W_O_H_6b47_ATACS", "UK3CB_CSAT_W_O_H_6b47_bala_ATACS"];
_sfslHat append [];
...
_eliteuniforms append ["UK3CB_CSAT_W_O_U_CombatUniform"];
_eliteslUniforms append [];
_elitevests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Light", "UK3CB_CSAT_W_O_V_Carrier_Rig_Compact"];
_eliteHvests append [];
_eliteMGvests append [];
_eliteMEDvests append [];
_eliteSLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Crew", "UK3CB_CSAT_W_O_V_Carrier_Rig_Compact"];
_eliteSNIvests append [];
_eliteGLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_CQB", "UK3CB_CSAT_W_O_V_Carrier_Rig_Tactical"];
_elitebackpacks append ["UK3CB_CSAT_W_O_B_ASS", "UK3CB_CSAT_O_B_TACPACK_BRN"];
_eliteatBackpacks append [];
_eliteaaBackpacks append [];
_elitemedBackpacks append [];
_aliteengBackpacks append [];
_eliteexpBackpacks append ["UK3CB_CSAT_W_O_B_FIELDPACK", "UK3CB_CSAT_W_O_B_RIF"];
_elitelongRangeRadios append [];
_elitehelmets append ["UK3CB_CSAT_W_O_H_6b27m", "UK3CB_CSAT_W_O_H_6b27m_ESS", "UK3CB_H_Ballistic_Mask_CSAT_W"];
_eliteslHat append [];
...
_militaryuniforms append ["UK3CB_CSAT_W_O_U_CombatUniform"];
_militaryslUniforms append [];
_militaryvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Light", "UK3CB_CSAT_W_O_V_Carrier_Rig_Compact"];
_militaryHvests append [];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Crew", "UK3CB_CSAT_W_O_V_Carrier_Rig_Compact"];
_militarySNIvests append [];
_militaryGLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_CQB", "UK3CB_CSAT_W_O_V_Carrier_Rig_Tactical"];
_militarybackpacks append ["UK3CB_CSAT_W_O_B_ASS", "UK3CB_CSAT_O_B_TACPACK_BRN"];
_militaryatBackpacks append [];
_militaryaaBackpacks append [];
_militarymedBackpacks append [];
_militaryengBackpacks append [];
_militaryexpBackpacks append ["UK3CB_CSAT_W_O_B_FIELDPACK", "UK3CB_CSAT_W_O_B_RIF"];
_militarylongRangeRadios append [];
_militaryhelmets append ["UK3CB_CSAT_W_H_PASGT", "UK3CB_CSAT_W_H_PASGT_RHINO"];
...
_policeuniforms append ["UK3CB_CSAT_W_O_U_CombatUniform_Shortsleeve"];
_policevests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Recon", "UK3CB_CSAT_W_O_V_Carrier_Rig_Compact"];
_policehelmets append ["UK3CB_CSAT_W_O_H_Cap", "UK3CB_CSAT_W_O_H_Patrolcap_Mic", "UK3CB_CSAT_O_H_Woolhat_KHK"];
...
_militiauniforms append ["UK3CB_CSAT_W_O_U_CombatUniform", "UK3CB_CSAT_W_O_U_CombatUniform_Shortsleeve", "UK3CB_CSAT_W_O_U_JumperUniform"];
_militiaslUniforms append [];
_militiavests append ["UK3CB_CSAT_W_O_V_TacVest", "UK3CB_TKP_I_V_6Sh92_Khk"];
_militiaHvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Tactical"];
_militiaMGvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Tactical", "UK3CB_CSAT_W_O_V_Carrier_Rig_CQB"];
_militiaMEDvests append [];
_militiaSLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Light", "UK3CB_CSAT_W_O_V_Carrier_Rig_Compact"];
_militiaSNIvests append [];
_militiaGLvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Heavy"];
_militiabackpacks append ["UK3CB_CSAT_W_O_B_ASS", "UK3CB_CSAT_W_O_B_ENG"];
...
_militiahelmets append ["UK3CB_CSAT_W_H_PASGT", "UK3CB_CSAT_W_O_H_SSh68_Covered", "UK3CB_CSAT_O_H_Woolhat_KHK"];
...
_crewuniforms append ["UK3CB_CSAT_W_O_U_Tank_Uniform"];
_crewvests append ["UK3CB_CSAT_W_O_V_Carrier_Rig_Light", "UK3CB_CSAT_W_O_V_Carrier_Rig_Crew"];
_crewhelmets append ["rhs_tsh4", "UK3CB_CSAT_W_O_H_SSh68_Covered_Medic"];
...
_pilotuniforms append ["UK3CB_CSAT_W_O_U_J_Pilot", "UK3CB_CSAT_N_O_U_J_Pilot"];
