...
_tanks append [];
_lightTanks append [];
_aa append ["UK3CB_KDF_B_Ural_Zu23", "UK3CB_FIA_B_Hilux_Zu23", "UK3CB_FIA_B_Hilux_Zu23_Front"];
...
_staticMG append ["UK3CB_NAP_I_DSHKM", "UK3CB_FIA_I_M240_Low", "UK3CB_FIA_I_M240_High", "UK3CB_MEI_I_KORD_high", "UK3CB_MEI_I_KORD", "UK3CB_MEI_I_PKM_Low", "UK3CB_MEI_I_DSHkM_Mini_TriPod"];
_staticAT append ["UK3CB_UN_I_SPG9"];
_staticAA append ["UK3CB_UN_I_ZU23"];
_staticMortars append ["UK3CB_FIA_I_M252", "rhsgref_ins_g_2b14"];
_howitzers append [];
_radar append [];
_SAM append [];
