/* Faction : 3CBF US USMC Temperate
 * Required mods/addons: "UK3CB_Factions_FIA_B"
 * Optional mods/addons:
 */
_basic              append ["UK3CB_B_M1030_USMC_DES"];
_unarmedVehicles    append ["rhsusf_m1165_usmc_d", "rhsusf_m1151_usmc_d", "rhsusf_m1025_d_s", "rhsusf_m1043_d_s", "rhsusf_CGRCAT1A2_usmc_d", "rhsusf_m1240a1_usmc_d"];
_armedVehicles      append ["rhsusf_m1240a1_m2_usmc_d", "rhsusf_m1240a1_m240_usmc_d", "rhsusf_m1240a1_mk19_usmc_d", "rhsusf_m1151_m2crows_usmc_d", "rhsusf_m1151_mk19crows_usmc_d", "rhsusf_m1151_m2_v3_usmc_d", "rhsusf_m1151_m240_v3_usmc_d", "rhsusf_m1151_mk19_v3_usmc_d", "rhsusf_CGRCAT1A2_M2_usmc_d", "rhsusf_CGRCAT1A2_Mk19_usmc_d", "rhsusf_m1240a1_mk19crows_usmc_d", "rhsusf_m1240a1_m2crows_usmc_d"];
_Trucks             append ["rhsusf_M1078A1P2_B_D_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_D_fmtv_usarmy", "rhsusf_M1083A1P2_B_D_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_D_fmtv_usarmy"];
...
_lightAPCs          append ["UK3CB_B_LAV25_HQ_US_DES"];
_APCs               append ["UK3CB_B_LAV25_US_DES"];
_IFVs               append [];
_airborneVehicles   append ["UK3CB_B_LAV25_US_DES"];
_tanks              append ["rhsusf_m1a1hc_wd", "rhsusf_m1a1fep_d"];
_lightTanks         append ["RHS_M2A2"];
_aa                 append ["RHS_M6"];
...
_helisLight             append ["RHS_UH1Y_UNARMED_d"];
_transportHelicopters   append ["rhsusf_CH53E_USMC_D", "rhsusf_CH53E_USMC_GAU21_D", "RHS_UH1Y_UNARMED_d", "RHS_UH1Y_d"];
_helisLightAttack       append ["RHS_UH1Y_d", "RHS_UH1Y_FFAR_d", "RHS_UH1Y_d_GS"];
_helisAttack            append ["RHS_AH1Z", "RHS_AH1Z_CS", "RHS_AH1Z_GS"];
_airPatrol              append ["RHS_UH1Y_UNARMED_d"];
...
_militiaLightArmed  append ["rhsusf_m1025_d_s_m2", "rhsusf_m1043_d_s_m2", "rhsusf_m1025_d_s_m2", "rhsusf_m1043_d_s_m2", "rhsusf_m1045_d_s"];
_militiaTrucks      append ["UK3CB_B_MTVR_Open_USMC_DES", "UK3CB_B_MTVR_Closed_USMC_DES"];
_militiaCars        append ["rhsusf_m998_d_s_2dr_halftop", "rhsusf_m998_d_s_2dr", "rhsusf_m998_d_s_2dr_fulltop", "rhsusf_m998_d_s_4dr_halftop", "rhsusf_m998_d_s_4dr", "rhsusf_m998_d_s_4dr_fulltop"];
_militiaAPCs        append ["UK3CB_B_AAV_US_DES"]; 

_policeVehs append ["rhsusf_m998_d_s_4dr", "rhsusf_m998_d_s_4dr_halftop", "rhsusf_m998_d_s_4dr_fulltop"];

_staticMG       append ["RHS_M2StaticMG_D", "UK3CB_B_Static_M240_Elcan_High_USMC_D"];
...
_officerUniforms append ["rhs_uniform_FROG01_d"];
_officerVests append ["V_Rangemaster_belt"];
_officerHats append ["rhs_8point_marpatd"];
...
_helmets append [];
_slHat append ["rhsusf_lwh_helmet_marpatd_headset", "rhs_8point_marpatd"];
...
_sfuniforms append ["rhs_uniform_g3_tan"];
...
_sfbackpacks append ["rhsusf_assault_eagleaiii_ocp", "rhsusf_falconii_coy"];
...
_sfhelmets append ["H_Bandanna_sand", "rhsusf_opscore_mar_ut", "rhsusf_opscore_mar_ut_pelt", "H_Watchcap_cbr"];
_sfslHat append [];
_sfsniHats append [];
...
_eliteuniforms append ["rhs_uniform_g3_tan"];
...
_elitehelmets append ["rhsusf_opscore_mar_ut", "rhsusf_opscore_mar_ut_pelt"];
_eliteslHat append [];
...
_militaryuniforms append ["rhs_uniform_FROG01_d"];
...
_militaryhelmets append ["rhsusf_lwh_helmet_marpatd", "rhsusf_lwh_helmet_marpatd_ess", "rhsusf_lwh_helmet_marpatd_headset"];
...
_policevests append ["UK3CB_ADA_B_V_TacVest_KHK", "V_BandollierB_cbr"];
...
_militiauniforms append ["rhs_uniform_FROG01_d"];
...
_militiabackpacks append ["rhsusf_assault_eagleaiii_ocp", "B_Kitbag_mcamo", "rhsusf_falconii_mc"];
...
_militiahelmets append ["rhsusf_lwh_helmet_marpatd", "rhsusf_lwh_helmet_marpatd_ess", "H_Bandanna_sand", "rhs_8point_marpatd"];
...
_crewuniforms append ["rhs_uniform_FROG01_d"];
...
_pilotuniforms append ["rhs_uniform_FROG01_d"];
...
if (isClass (configFile >> "CfgVehicles" >> "FIR_F22")) then {
	_planesCAS   append ["FIR_F22"];
};

if (isClass (configFile >> "CfgVehicles" >> "FIR_F16C")) then {
	_planesCAS   append ["FIR_F16C"];
	_planesAA 	 append ["FIR_F16C"];
};