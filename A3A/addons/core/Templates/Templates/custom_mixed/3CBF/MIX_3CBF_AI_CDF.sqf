...
_repairTrucks append ["UK3CB_B_Kamaz_Repair_CDF", "UK3CB_B_Ural_Repair_CDF", "rhsgref_cdf_b_gaz66_repair", "rhsgref_cdf_b_ural_repair"];
_fuelTrucks append ["rhsgref_cdf_b_ural_fuel"];
_medicalTrucks append ["rhsgref_cdf_b_gaz66_ap2"];
_lightAPCs append ["rhsgref_cdf_b_btr60", "rhsgref_cdf_b_btr70", "rhsgref_cdf_b_btr80"];
_APCs append ["rhsgref_cdf_b_bmp2e", "rhsgref_cdf_b_bmp2", "rhsgref_cdf_b_bmp2d", "rhsgref_cdf_b_bmp2k", "rhsgref_cdf_b_bmd1", "rhsgref_cdf_b_bmd1p", "rhsgref_cdf_b_bmd1pk", "rhsgref_cdf_b_bmd2", "rhsgref_cdf_b_bmd2k"];
_IFVs append [];
_airborneVehicles append ["rhsgref_cdf_b_bmd1", "rhsgref_cdf_b_bmd1k", "rhsgref_cdf_b_bmd1p", "rhsgref_cdf_b_bmd1pk", "rhsgref_cdf_b_bmd2","rhsgref_cdf_b_bmd2k"];
_tanks append ["rhsgref_cdf_b_2s1_at","rhsgref_cdf_b_t72ba_tv", "rhsgref_cdf_b_t72bb_tv", "rhsgref_cdf_b_t80b_tv", "rhsgref_cdf_b_t80bv_tv", "rhsgref_cdf_b_t80u_tv", "rhsgref_cdf_b_t80uk_tv"];
_lightTanks append ["rhsgref_cdf_b_bmd1k", "UK3CB_B_T55_CDF"];
_aa append ["rhsgref_cdf_b_zsu234"];
...
_planesCAS append ["rhs_l159_cdf_b_CDF", "rhsgref_cdf_b_su25"];
_planesAA append ["rhs_l159_cdf_b_CDF_CAP", "rhsgref_cdf_b_mig29s"];

_planesTransport append ["RHS_C130J"];
_gunship append [];

_helisLight append ["rhsgref_cdf_b_reg_Mi8amt"];
...
_helisLightAttack append ["rhsgref_cdf_b_reg_Mi17Sh"];
_helisAttack append ["rhsgref_cdf_b_Mi24D", "rhsgref_cdf_b_Mi24D_Early", "rhsgref_b_mi24g_CAS", "rhsgref_cdf_b_Mi35"];
_airPatrol append [];

_artillery append ["rhsgref_cdf_b_2s1", "rhsgref_cdf_b_reg_BM21"];
...
_militiaLightArmed append ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_spg9"];
_militiaTrucks append ["rhsgref_cdf_b_gaz66", "rhsgref_cdf_b_gaz66_flat", "rhsgref_cdf_b_gaz66o", "rhsgref_cdf_b_gaz66o_flat"];
_militiaCars append ["rhsgref_cdf_b_reg_uaz", "rhsgref_cdf_b_reg_uaz_open", "UK3CB_B_BTR40_CDF"];
_militiaAPCs append ["rhsgref_cdf_b_btr60", "rhsgref_cdf_b_btr70", "UK3CB_B_BTR40_MG_CDF"];

_policeVehs append ["UK3CB_CPD_B_UAZ_Closed", "UK3CB_CPD_B_Gaz24", "UK3CB_CPD_B_Lada", "UK3CB_CPD_B_S1203"];

_staticMG append ["rhsgref_cdf_b_DSHKM", "UK3CB_NFA_B_PKM_High", "RHS_M2StaticMG_WD"];
_staticAT append ["rhsgref_cdf_b_SPG9", "rhsgref_cdf_b_SPG9M"];
...
_voices append ["rhs_male01cz","rhs_male02cz","rhs_male03cz","rhs_male04cz","rhs_male05cz"];
_sfVoices append [];
_eliteVoices append [];
...
_antiInfantryGrenades append ["rhs_mag_rgn", "rhs_mag_rgo", "rhs_mag_m67"];
_antiTankGrenades append [];
_smokeGrenades append ["rhs_mag_rdg2_white", "rhs_mag_an_m8hc"];
...
_officerUniforms append ["rhsgref_uniform_ttsko_mountain", "rhsgref_uniform_ttsko_forest"];
_officerVests append ["rhs_gear_OFF", "rhs_vest_commander"];
_officerHats append ["rhsgref_fieldcap_ttsko_mountain", "rhsgref_fieldcap_ttsko_forest"];
...
_backpacks append [];
_ATBackpacks append [];
_AABackpacks append ["rhs_tortila_olive"];
_MGBackpacks append [];
_GLBackpacks append [];
_MEDBackpacks append ["rhs_medic_bag"];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["rhsgref_fieldcap_ttsko_mountain"];
_SNIhats append ["H_Booniehat_mgrn", "rhs_beanie_green"];
...
_sfuniforms append ["rhssaf_uniform_m10_digital"];
_sfMEDuniforms append [];
_sfENGuniforms append [];
_sfSLuniforms append [];
_sfvests append ["rhsgref_6b23_ttsko_digi_rifleman", "rhsgref_6b23_ttsko_digi"];
_sfHvests append [];
_sfMGvests append [];
_sfMEDvests append ["rhsgref_6b23_ttsko_digi_medic"];
_sfSLvests append ["rhsgref_6b23_ttsko_digi_nco", "rhsgref_6b23_ttsko_digi_officer"];
_sfSNIvests append ["rhsgref_6b23_ttsko_digi_sniper"];
_sfGLvests append [];
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["rhssaf_kitbag_digital", "B_AssaultPack_sgg"];
_sfATBackpacks append ["B_Carryall_oli"];
_sfAABackpacks append [];
_sfMGbackpacks append [];
_sfGLbackpacks append [];
_sfMEDBackpacks append ["B_AssaultPack_sgg"];
_sfENGBackpacks append [];
_sfEXPBackpacks append [];
_sfSLBackpacks append [];
_sflongRangeRadios append [];
_sfhelmets append ["rhsgref_fieldcap_ttsko_urban", "H_Bandanna_sgg", "rhs_beanie_green", "rhssaf_helmet_m97_digital", "rhssaf_helmet_m97_digital_black_ess_bare", "rhssaf_helmet_m97_digital_black_ess"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append [];
_sfSNIhats append ["rhssaf_booniehat_digital", "rhs_beanie_green"];
...
_elitesidearms append ["rhsusf_weap_glock17g4"];
...
_eliteradios append [];
_elitegpses append [];
_eliteNVGs append ["rhsusf_ANPVS_14"];
_elitebinoculars append ["rhsusf_bino_lerca_1200_black"];
_eliterangefinders append [];

_eliteuniforms append ["rhsgref_uniform_ttsko_mountain"];
_eliteSLuniforms append [];
_elitevests append ["rhs_6b5_rifleman_spetsodezhda", "rhs_6b5_spetsodezhda"];
_eliteHvests append [];
_eliteMGvests append [];
_eliteMEDvests append ["rhs_6b5_medic_spetsodezhda"];
_eliteSLvests append ["rhs_6b5_officer_spetsodezhda"];
_eliteSNIvests append [];
_eliteGLvests append [];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["B_Carryall_oli"];
_eliteATBackpacks append ["B_Carryall_oli"];
...
_elitehelmets append ["rhsgref_6b27m_ttsko_mountain", "rhs_beret_vdv1", "rhs_stsh81_butan"];
...
_militarysidearms append ["rhsusf_weap_glock17g4", "rhs_weap_6p53"];
...
_militaryuniforms append ["rhsgref_uniform_ttsko_mountain"];
_militaryENGuniforms append [];
_militarySLuniforms append [];
_militaryvests append ["rhsgref_6b23_ttsko_mountain_rifleman", "rhs_6b5_ttsko", "rhs_6b5_khaki", "rhs_6b5_rifleman_khaki", "rhs_6b5_rifleman_ttsko"];
_militaryHvests append [];
_militaryMGvests append [];
_militaryMEDvests append ["rhsgref_6b23_ttsko_mountain_medic", "rhs_6b5_medic_ttsko", "rhs_6b5_medic_khaki"];
_militarySLvests append ["rhsgref_6b23_ttsko_mountain_officer", "rhs_6b5_officer_ttsko", "rhs_6b5_officer_khaki"];
_militarySNIvests append ["rhsgref_6b23_ttsko_mountain_sniper", "rhs_6b5_sniper_khaki", "rhs_6b5_sniper_ttsko"];
...
_militaryMEDBackpacks append ["rhs_rd54_vest"];
_militaryENGBackpacks append [];
_militaryEXPBackpacks append [];
_militarySLBackpacks append [];
_militarylongRangeRadios append [];
_militaryhelmets append ["rhsgref_6b27m_ttsko_mountain", "rhsgref_6b27m_ttsko_mountain", "rhs_6b26_green", "rhsgref_ssh68_ttsko_mountain"];
...
_policeuniforms append ["UK3CB_CPD_B_U_CombatUniform_01_Urban"];
_policeSLuniforms append [];
_policevests append ["V_TacVest_blk"];
_policehelmets append ["H_Bandanna_blu", "H_MilCap_blue", "UK3CB_H_Woolhat_BLU", "UK3CB_H_Beret_Officer_Blu_Star"];
...
_militialightATLaunchers append ["rhs_weap_rpg18", "rhs_weap_rpg75"];
...
_militiasidearms append ["rhs_weap_makarov_pm", "rhs_weap_savz61_folded"];
...
_militiauniforms append ["rhsgref_uniform_ttsko_forest"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append [];
_militiavests append ["rhs_6b3", "rhs_6b3_AK", "rhs_6b3_AK_2", "rhs_6b3_AK_3", "rhs_6b3_RPK", "rhs_lifchik_light", "rhs_lifchik"];
_militiaHvests append [];
_militiaMGvests append ["rhs_6b3_RPK", "rhs_belt_RPK"];
_militiaMEDvests append [];
_militiaSLvests append ["rhs_6b3_holster", "rhs_6b3_off", "rhs_lifchik_NCO"];
_militiaSNIvests append [];
_militiaGLvests append ["rhs_6b3_VOG", "rhs_6b3_VOG_2", "rhs_lifchik_vog"];
_militiaATvests append ["rhs_6b3", "rhs_6b3_AK", "rhs_6b3_AK_2", "rhs_6b3_AK_3"];
_militiaENGvests append [];
_militiabackpacks append ["rhs_sidor"];
...
_militiahelmets append ["rhs_ssh60", "rhs_ssh68_2", "rhsgref_ssh68_ttsko_forest", "rhs_beanie_green", "rhs_fieldcap_m88_ttsko_alt_back", "rhs_fieldcap_m88_ttsko_alt", "rhs_ushanka"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append ["rhsgref_fieldcap_ttsko_forest"];
...
_crewuniforms append ["rhsgref_uniform_ttsko_mountain"];
_crewvests append ["rhs_6b2_holster", "rhs_6b2"];
...
_pilotuniforms append ["rhsgref_uniform_ttsko_mountain"];
_pilotvests append ["rhs_vest_commander"];
