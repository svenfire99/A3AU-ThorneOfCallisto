...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["rhsusf_patrolcap_ocp"];
...
_militiaSLhats append ["rhsusf_mich_bare_tan_headset", "rhsusf_mich_bare_norotos_alt_tan", "rhsusf_patrolcap_ocp", "H_Bandanna_sand"];
