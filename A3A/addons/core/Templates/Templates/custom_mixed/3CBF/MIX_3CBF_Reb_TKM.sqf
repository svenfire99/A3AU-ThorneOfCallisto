...
_tanks append [];
_lightTanks append [];
_aa append ["UK3CB_TKM_I_V3S_Zu23"];
...
_staticMG append ["UK3CB_TKM_I_DSHKM"];
_staticAT append ["UK3CB_TKM_I_SPG9"];
_staticAA append ["UK3CB_TKM_I_ZU23"];
_staticMortars append ["UK3CB_TKM_I_2b14_82mm"];
_howitzers append [];
_radar append [];
_SAM append [];
