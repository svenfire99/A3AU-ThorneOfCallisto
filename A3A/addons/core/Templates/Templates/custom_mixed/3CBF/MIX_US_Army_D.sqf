...
_airPatrol              append ["RHS_MELB_MH6M"];
...
_militiaTrucks      append ["UK3CB_B_M939_Guntruck_DES", "UK3CB_B_M939_Closed_DES", "UK3CB_B_M939_Open_DES"];
...
_glasses append ["G_Aviator","G_Squares_Tinted","G_Squares","rhsusf_shemagh_od","rhsusf_shemagh2_od","rhsusf_shemagh_tan","rhsusf_shemagh2_tan","rhs_googles_black", "rhs_googles_clear", "rhs_googles_orange0"];
...
_militaryhelmets append ["rhsusf_ach_helmet_ocp", "rhsusf_ach_helmet_ocp_alt", "rhsusf_ach_helmet_headset_ocp", "rhsusf_ach_helmet_headset_ocp_alt", "rhsusf_ach_helmet_camo_ocp"];
...
_militiauniforms append ["rhs_uniform_acu_oefcp"];
...
_militiahelmets append ["rhsusf_mich_bare_tan", "rhsusf_mich_bare_norotos_arc_tan", "rhsusf_mich_bare_norotos_tan", "rhsusf_patrolcap_ocp"];
...
if (isClass (configFile >> "CfgVehicles" >> "FIR_F15C")) then {
	_planesCAS   append ["FIR_F15C"];
};

if (isClass (configFile >> "CfgVehicles" >> "FIR_F18C")) then {
	_planesCAS   append ["FIR_F18C"];
	_planesAA 	 append ["FIR_F18C"];
};

if (isClass (configFile >> "CfgVehicles" >> "FIR_F14B")) then {
	_planesCAS   append ["FIR_F14B"];
};
