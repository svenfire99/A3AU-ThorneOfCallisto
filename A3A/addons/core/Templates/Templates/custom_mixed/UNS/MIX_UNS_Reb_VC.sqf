...
_staticMG append ["uns_pk_high_VC"];
_staticAT append ["uns_Type36_57mm_VC"];
_staticAA append ["uns_ZPU2_VC"];
_staticMortars append ["uns_m1941_82mm_mortarVC"];
_howitzers append [];
_radar append [];
_SAM append [];
