/* Faction : NATO
 * Converted from: Aegis_AI_NATO_Temperate.sqf
 */
_basic append ["B_W_Quadbike_01_F"];
_lightUnarmed append ["B_W_MRAP_01_F"];
_lightArmed append [ "B_W_MRAP_01_gmg_F", "B_W_MRAP_01_hmg_F"];
_Trucks append ["B_W_Truck_01_covered_F", "B_W_Truck_01_transport_F"];
_cargoTrucks append ["B_W_Truck_01_cargo_F", "B_W_Truck_01_flatbed_F","B_W_UGV_01_F"];
_ammoTrucks append ["B_W_Truck_01_ammo_F"];
_repairTrucks append ["B_W_Truck_01_Repair_F"];
_fuelTrucks append ["B_W_Truck_01_fuel_F"];
_medicalTrucks append ["B_W_APC_Wheeled_01_medical_F", "B_W_Truck_01_medical_F"];
_lightAPCs append ["B_W_APC_Wheeled_01_cannon_v2_F"];
_APCs append ["B_W_APC_Wheeled_01_cannon_v2_F"];
_IFVs append ["B_W_APC_Tracked_01_rcws_F"];
_airborneVehicles append ["B_W_APC_Wheeled_01_cannon_v2_F","B_W_UGV_01_rcws_F"];
_tanks append ["B_W_MBT_01_cannon_F", "B_W_MBT_01_TUSK_F"];
_lightTanks append ["B_W_AFV_Wheeled_01_cannon_F", "B_W_AFV_Wheeled_01_up_cannon_F","B_W_UGV_01_rcws_F"];
_aa append ["B_W_APC_Tracked_01_AA_F"];
...
_planesTransport append ["Atlas_B_A_Plane_Transport_01_infantry_F", "B_T_VTOL_01_infantry_F"];
_gunship append [];

_helisLight append ["B_W_Heli_light_01_F"];
_transportHelicopters append ["B_W_Heli_Transport_01_F"];
_helisLightAttack append ["B_W_Heli_Light_01_dynamicLoadout_F"];
_helisAttack append ["B_W_Heli_Attack_01_dynamicLoadout_F"];
_airPatrol append [];

_artillery append ["B_W_MBT_01_arty_F","B_W_MBT_01_mlrs_F"];
...
_uavsAttack append ["B_T_UAV_03_dynamicLoadout_F", "B_UAV_05_F", "B_W_UAV_02_dynamicLoadout_F"];
_uavsPortable append if (_hasWs) then {["Aegis_B_W_UAV_02_lxWS", "B_W_UAV_01_F"]} else {["B_W_UAV_01_F"]};

_militiaLightArmed append ["B_W_LSV_01_armed_F", "B_W_LSV_01_armed_F", "B_W_LSV_01_armed_F", "B_W_LSV_01_AT_F"];
_militiaTrucks append ["B_W_Truck_01_covered_F", "B_W_Truck_01_transport_F"];
_militiaCars append ["B_W_LSV_01_unarmed_F", "B_W_LSV_01_light_F"];
_militiaAPCs append [];
...
_staticMG append ["B_W_HMG_02_high_F", "B_W_HMG_02_high_F", "B_W_HMG_02_high_F", "B_W_HMG_01_high_F"];
_staticAT append ["B_W_Static_AT_F"];
_staticAA append ["B_W_Static_AA_F"];
_staticMortars append ["B_W_Mortar_01_F"];
_howitzers append [];
_radar append ["B_W_Radar_System_01_F"];
_SAM append ["B_W_SAM_System_03_F"];
...
_sidearms append ["hgun_P07_blk_F", "hgun_G17_black_F"];
_GLsidearms append [];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["H_Beret_02", "H_MilCap_wdl"];
_SNIhats append ["H_Booniehat_wdl", "H_Booniehat_wdl_hs", "H_Cap_headphones"];
...
_sfdesignatedGrenadeLaunchers append [["GL_XM25_F", "", "", "", ["5Rnd_25x40mm_HE", "5Rnd_25x40mm_HE", "5Rnd_25x40mm_airburst"], ["5Rnd_25x40mm_HE", "5Rnd_25x40mm_HE", "5Rnd_25x40mm_airburst"], ""]];
_sfSMGs append [];
...
_sfuniforms append ["U_B_CTRG_Soldier_Black_F", "U_B_CTRG_Soldier_3_Black_F", "U_B_CTRG_Soldier_2_Black_F"];
...
_sfATBackpacks append ["B_TacticalPack_blk", "B_Carryall_blk"];
...
_sffacewear append ["G_Balaclava_TI_G_blk_F"];
...
_eliteradios append [];
_elitegpses append [];
_eliteNVGs append ["Aegis_NVG_IVAS_01_grn_F", "NVGoggles_INDEP", "NVGoggles_INDEP", "NVGoggles_INDEP"];
_elitebinoculars append ["Laserdesignator"];
_eliterangefinders append [];

_eliteuniforms append ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_tshirt_mcam_wdL_f", "U_B_CombatUniform_vest_mcam_wdl_f"];
_eliteSLuniforms append [];
_elitevests append ["V_PlateCarrier1_wdl", "V_PlateCarrier2_wdl", "Aegis_V_PlateCarrier2_alt_wdl"];
_eliteHvests append ["Aegis_V_PlateCarrier2_alt_wdl", "V_PlateCarrierSpec_wdl"];
_eliteMGvests append [];
_eliteMEDvests append [];
_eliteSLvests append [];
_eliteSNIvests append [];
_eliteGLvests append ["Aegis_V_PlateCarrier2_alt_wdl", "V_PlateCarrierGL_wdl"];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["B_AssaultPack_wdl_F", "B_AssaultPackSpec_wdl_F", "B_Kitbag_wdl_F", "B_Carryall_wdl_F"];
_eliteATBackpacks append ["B_Kitbag_wdl_F", "B_Carryall_wdl_F"];
...
_elitehelmets append ["H_HelmetSpecB_wdl", "H_HelmetSpecB_light_wdl", "Aegis_H_Helmet_FASTMT_Cover_wdl_F"];
...
_militaryuniforms append ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_tshirt_mcam_wdL_f", "U_B_CombatUniform_vest_mcam_wdl_f"];
_militaryENGuniforms append [];
_militarySLuniforms append [];
_militaryvests append ["V_PlateCarrier1_wdl", "V_PlateCarrier2_wdl", "Aegis_V_PlateCarrier2_alt_wdl"];
_militaryHvests append ["V_PlateCarrier1_wdl", "V_PlateCarrier2_wdl", "Aegis_V_PlateCarrier2_alt_wdl", "V_PlateCarrierSpec_wdl"];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append [];
_militarySNIvests append [];
_militaryGLvests append ["V_PlateCarrier1_wdl", "V_PlateCarrier2_wdl", "Aegis_V_PlateCarrier2_alt_wdl", "V_PlateCarrierGL_wdl"];
_militaryATvests append [];
_militaryENGvests append [];
_militarybackpacks append ["B_AssaultPack_wdl_F", "B_AssaultPackSpec_wdl_F", "B_Kitbag_wdl_F", "B_Carryall_wdl_F"];
_militaryATBackpacks append ["B_Kitbag_wdl_F", "B_Carryall_wdl_F"];
...
_policesidearms append ["hgun_G17_black_F", "hgun_P07_blk_F", "hgun_P07_blk_F"];
...
_militiasidearms append ["hgun_ACPC2_black_F", "hgun_G17_black_F"];
...
_militiauniforms append ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_tshirt_mcam_wdL_f", "U_B_CombatUniform_vest_mcam_wdl_f"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append [];
_militiavests append ["V_Chestrig_oli", "V_PlateCarrier1_wdl"];
...
_militiabackpacks append ["B_AssaultPack_wdl_F", "B_Kitbag_wdl_F"];
_militiaATBackpacks append ["B_Kitbag_wdl_F"];
...
_militiahelmets append ["H_HelmetB_light_wdl", "H_HelmetB_light_wdl", "H_Bandanna_camo", "H_Cap_oli", "H_Watchcap_camo"];
...
_crewuniforms append ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_vest_mcam_wdl_f"];
_crewvests append ["V_TacVest_grn"];
...
if (_hasWs) then {["Aegis_B_W_UAV_02_lxWS", "B_W_UAV_01_F"]}
