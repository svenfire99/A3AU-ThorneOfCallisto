...
_unarmedVehicles append ["O_R_MRAP_02_F"];
_armedVehicles append ["O_R_MRAP_02_hmg_F", "O_R_MRAP_02_gmg_F"];
...
if (_hasApex) then {
    _unarmedVehicles pushBack "O_R_LSV_02_unarmed_F";
    _armedVehicles append ["O_R_LSV_02_AT_F", "O_R_LSV_02_armed_F"];
};
