...
_repairTrucks append ["B_A_Truck_01_Repair_wdl_F"];
_fuelTrucks append ["B_A_Truck_01_fuel_wdl_F"];
_medicalTrucks append ["B_A_Truck_01_medical_wdl_F", "B_W_APC_Wheeled_01_medical_F"];
_lightAPCs append ["Atlas_B_G_APC_Wheeled_03_cannon_F"];
_APCs append ["B_A_APC_tracked_03_cannon_v2_wdl_F"];
_IFVs append [];
_airborneVehicles append ["Atlas_B_G_APC_Wheeled_03_cannon_F","B_D_UGV_01_rcws_lxWS"];
_tanks append ["Atlas_B_A_MBT_03_cannon_F"];
_lightTanks append ["B_D_UGV_01_rcws_lxWS"];
...
_helisLight append ["B_A_Heli_light_03_unarmed_wdl_F"];
_transportHelicopters append ["B_A_Heli_Transport_02_wdl_F", "Aegis_B_UN_lxWS_Heli_Transport_02_Heavy_F"];
_helisLightAttack append ["B_A_Heli_light_03_dynamicLoadout_wdl_F"];
_helisAttack append ["B_A_Heli_Attack_01_dynamicLoadout_wdl_F", "Atlas_B_A_Heli_Attack_03_F"];
_airPatrol append [];
...
_uavsAttack append ["B_A_UAV_02_dynamicLoadout_wdl_F"];
_uavsPortable append if (_hasWs) then {["Aegis_B_A_UAV_02_wdl_lxWS", "B_A_UAV_01_wdl_F"]} else {["B_A_UAV_01_wdl_F"]};

_militiaLightArmed append ["Atlas_B_A_MRAP_03_hmg_F"];
_militiaTrucks append ["Atlas_B_A_Truck_01_covered_F", "Atlas_B_A_Truck_01_transport_F"];
_militiaCars append ["Atlas_B_A_MRAP_03_F"];
_militiaAPCs append ["Atlas_B_A_APC_Wheeled_01_cannon_v2_F", "Atlas_B_A_APC_Wheeled_01_command_lxWS"];
...
_staticMG append ["B_A_HMG_02_high_wdl_F", "B_A_HMG_01_high_wdl_F"];
_staticAT append ["B_A_Static_AT_wdl_F"];
_staticAA append ["B_A_Static_AA_wdl_F"];
_staticMortars append ["B_A_Mortar_01_wdl_F"];
_howitzers append [];
_radar append ["B_A_Radar_System_01_wdl_F"];
_SAM append ["B_A_SAM_System_03_wdl_F"];
...
_officerUniforms append ["Atlas_U_B_A_CombatUniform_aucamo"];
...
_SNIhats append ["H_Booniehat_aucamo_F", "H_Watchcap_khk"];
...
_sfuniforms append ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_vest_mcam_wdl_f", "U_B_CombatUniform_tshirt_mcam_wdL_f"];
...
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["B_AssaultPackSpec_rgr", "B_AssaultPackSpec_rgr", "B_Bergen_wdl_F", "B_Carryall_wdl_F", "B_Kitbag_wdl_F"];
_sfATBackpacks append ["B_Carryall_wdl_F", "B_Kitbag_wdl_F"];
...
_sfhelmets append ["H_HelmetSpecB_wdl", "H_HelmetB_plain_wdl", "H_Booniehat_wdl", "H_Watchcap_khk", "H_Bandanna_khk"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append [];
_sfSNIhats append ["H_Booniehat_wdl_hs"];
...
_elitebackpacks append ["B_Bergen_wdl_F", "B_Carryall_wdl_F", "B_Kitbag_wdl_F"];
...
_elitehelmets append ["H_HelmetSpecB_wdl", "H_HelmetB_camo_wdl", "H_HelmetB_plain_wdl", "H_HelmetB_TI_tna_F"];
_eliteMEDhelmets append [];
_eliteSLhelmets append [];
_eliteSLhats append [];
_eliteSNIhats append ["H_Watchcap_khk"];

_elitefacewear append ["G_Balaclava_TI_G_tna_F"];
...
_militiasidearms append ["hgun_G17_black_F", "hgun_G17_black_F"];
...
_crewuniforms append ["U_B_UBACS_wdl_f", "U_B_UBACS_vest_wdl_f"];
...
_pilotuniforms append ["U_B_UBACS_wdl_f", "U_B_UBACS_vest_wdl_f"];
