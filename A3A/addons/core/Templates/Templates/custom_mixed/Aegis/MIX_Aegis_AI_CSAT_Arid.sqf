...
_cloakUniforms append ["U_O_FullGhillie_ard", "U_O_FullGhillie_sard", "U_O_GhillieSuit", "U_O_C_D_Sniper_oicamo_F"];
_cloakVests append ["V_HarnessOSpec_brn", "V_HarnessO_brn", "V_TacVest_khk"];
_cloakRifles append [];
