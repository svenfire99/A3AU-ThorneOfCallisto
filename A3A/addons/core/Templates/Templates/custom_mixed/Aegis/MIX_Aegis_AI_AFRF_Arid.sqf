...
_repairTrucks append ["O_R_Truck_02_box_ard_F", "O_R_Truck_02_box_ard_F"];
_fuelTrucks append ["O_R_Truck_03_fuel_ard_F", "O_R_Truck_02_fuel_ard_F"];
_medicalTrucks append ["O_R_Truck_03_medical_ard_F", "O_R_Truck_02_medical_ard_F", "O_R_APC_Tracked_02_medical_ard_F"];
_lightAPCs append ["O_R_APC_Wheeled_04_cannon_ard_F"];
_APCs append ["Aegis_O_R_APC_Tracked_02_30mm_ard_lxWS"];
_IFVs append ["Aegis_O_R_APC_Tracked_02_30mm_ard_lxWS"];
_airborneVehicles append ["O_R_APC_Wheeled_04_cannon_ard_F","O_R_UGV_01_rcws_F"];
_tanks append ["O_R_MBT_02_cannon_ard_F"];
_lightTanks append ["O_R_UGV_01_rcws_F"];
_aa append ["Aegis_O_R_Truck_02_aa_ard_F", "O_R_APC_Tracked_02_AA_ard_F"];
...
_planesCAS append ["O_R_Plane_CAS_02_dynamicLoadout_ard_F","O_R_Plane_Fighter_02_ard_F","O_T_VTOL_02_infantry_dynamicLoadout_F"];
_planesAA append ["O_R_Plane_Fighter_02_Stealth_ard_F","O_T_VTOL_02_infantry_dynamicLoadout_F"];

_planesTransport append ["O_T_VTOL_02_infantry_dynamicLoadout_F", "O_Plane_Transport_01_infantry_F"];
_gunship append [];

_helisLight append ["O_R_Heli_Light_02_unarmed_ard_F"];
_transportHelicopters append ["O_R_Heli_Light_02_unarmed_ard_F"];
_helisLightAttack append ["O_R_Heli_Light_02_dynamicLoadout_ard_F"];
_helisAttack append ["Aegis_O_R_Heli_Attack_04_ard_F", "O_R_Heli_Attack_02_dynamicLoadout_ard_F"];
_airPatrol append [];

_artillery append ["O_R_MBT_02_arty_ard_F", "O_R_Truck_02_MRL_F"];
...
_uavsAttack append ["O_R_UAV_02_dynamicLoadout_ard_F"];
_uavsPortable append if (_hasWs) then {["Aegis_O_R_UAV_02_ard_lxWS", "O_R_UAV_01_ard_F"]} else {["O_R_UAV_01_ard_F"]};

_militiaLightArmed append ["O_G_Offroad_01_armed_F", "O_G_Offroad_01_AT_F"];
_militiaTrucks append ["O_R_Truck_02_ard_F", "O_R_Truck_02_transport_ard_F"];
_militiaCars append ["O_G_Offroad_01_F"];
_militiaAPCs append ["O_R_APC_Wheeled_04_cannon_ard_F"];
...
_staticAT append ["O_R_Static_AT_ard_F"];
_staticAA append ["O_R_Static_AA_ard_F"];
_staticMortars append ["O_R_Mortar_01_ard_F"];
_howitzers append [];
_radar append ["O_R_Radar_System_02_ard_F"];
_SAM append ["O_R_SAM_System_04_ard_F"];
...
_traitorUniforms append ["U_O_R_officer_noInsignia_arid_F"];
_traitorVests append ["V_TacVest_oli", "V_BandollierB_rgr"];
_traitorHats append ["H_Watchcap_khk_hs", "H_MilCap_grn"];

_officerUniforms append ["U_O_R_OfficerUniform_arid_F"];
_officerVests append ["V_Rangemaster_belt"];
_officerHats append ["H_MilCap_grn"];
...
_SLBackpacks append [];
_longRangeRadios append ["B_RadioBag_01_arid_F"];
_helmets append [];
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["H_Watchcap_khk_hs", "H_MilCap_grn"];
_SNIhats append ["H_Cap_headphones", "H_Booniehat_mgrn"];
...
_sfhelmets append ["H_HelmetAggressor_cover_F", "H_HelmetAggressor_F", "H_Bandanna_khk", "H_Watchcap_camo_hs", "H_Booniehat_mgrn"];
...
_eliteuniforms append ["U_O_R_CombatUniform_arid_F", "U_O_R_CombatUniform_arid_F", "U_O_R_CombatUniform_arid_F", "U_O_R_CombatUniform_tshirt_arid_F"];
_eliteSLuniforms append [];
_elitevests append ["V_TacVest_grn"];
_eliteHvests append ["V_HarnessOSpec_tan"];
_eliteMGvests append [];
_eliteMEDvests append [];
_eliteSLvests append [];
_eliteSNIvests append [];
_eliteGLvests append ["V_HarnessOSpec_tan"];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["B_Carryall_cbr", "B_Carryall_cbr", "B_FieldPack_khk"];
...
_elitehelmets append ["H_HelmetAggressor_cover_F", "H_HelmetAggressor_F"];
...
_militaryuniforms append ["Atlas_U_O_Afghanka_01_ruarid_F", "Atlas_U_O_Afghanka_02_ruarid_F"];
_militaryENGuniforms append [];
_militarySLuniforms append ["Aegis_U_O_LightCombatFatigues_ruarid_F"];
_militaryvests append ["Aegis_V_OCarrierLuchnik_Lite_arid_F", "Aegis_V_OCarrierLuchnik_Lite_khk_F", "Aegis_V_OCarrierLuchnik_CQB_arid_F", "Aegis_V_OCarrierLuchnik_CQB_khk_F", "V_SmershVest_01_khaki_F", "V_SmershVest_01_radio_khaki_F"];
_militaryHvests append [];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append [];
_militarySNIvests append [];
_militaryGLvests append ["Aegis_V_OCarrierLuchnik_GL_arid_F", "Aegis_V_OCarrierLuchnik_GL_khk_F",  "Aegis_V_OCarrierLuchnik_CQB_arid_F", "Aegis_V_OCarrierLuchnik_CQB_khk_F"];
_militaryATvests append [];
_militaryENGvests append [];
_militarybackpacks append ["B_FieldPack_cbr", "B_Carryall_cbr"];
_militaryATBackpacks append ["B_Carryall_cbr"];
...
_militaryhelmets append ["H_HelmetLuchnik_cover_ruarid_F", "H_HelmetLuchnik_cover_khk_F", "H_HelmetLuchnik_brn_F", "H_HelmetLuchnik_headset_brn_F"];
...
_militiauniforms append ["Atlas_U_O_Afghanka_01_ruarid_F", "Atlas_U_O_Afghanka_02_ruarid_F"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append ["U_O_R_officer_noInsignia_arid_F"];
_militiavests append ["Aegis_V_ChestrigEast_RUarid_F", "Aegis_V_ChestrigEast_grn_F", "V_TacVest_grn"];
...
_militiahelmets append ["lxWS_H_ssh40_sand", "H_HelmetLuchnik_olive_F", "H_MilCap_grn", "H_Watchcap_khk"];
...
_crewuniforms append ["Aegis_U_O_LightCombatFatigues_ruarid_F"];
...
if (_hasWs) then {["Aegis_O_R_UAV_02_ard_lxWS", "O_R_UAV_01_ard_F"]}
