...
_traitorUniforms append ["cwr3_b_uniform_desert_6color"];
_traitorVests append ["cwr3_b_vest_alice_officer"];
_traitorHats append ["cwr3_b_headgear_cap_desert_6color"];

_officerUniforms append ["cwr3_b_uniform_desert_6color"];
_officerVests append ["cwr3_b_vest_pasgt_alice_6color_desert_officer"];
_officerHats append ["cwr3_b_headgear_cap_desert_6color"];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["cwr3_b_headgear_cap_desert_6color"];
_SNIhats append ["cwr3_b_headgear_cap_desert_6color"];
