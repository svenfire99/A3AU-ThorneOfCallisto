/* Faction : USMC
 * Converted from: CWR_AI_USMC_Temperate.sqf
 */
_basic append ["cwr3_b_usmc_m151"];
_lightUnarmed append ["cwr3_b_usmc_hmmwv","cwr3_b_usmc_hmmwv_transport"];
_lightArmed append ["cwr3_b_usmc_hmmwv_m2"];
_Trucks append ["cwr3_b_usmc_m939"];
_cargoTrucks append ["cwr3_b_usmc_m939_open"];
_ammoTrucks append ["cwr3_b_usmc_m939_reammo"];
_repairTrucks append ["cwr3_b_usmc_m939_repair"];
_fuelTrucks append ["cwr3_b_usmc_m939_refuel"];
_medicalTrucks append ["cwr3_b_usmc_hmmwv_mev"];
_lightAPCs append ["cwr3_b_usmc_lav25_hq", "cwr3_b_usmc_aav"];
_APCs append ["cwr3_b_usmc_lav25m240", "cwr3_b_usmc_lav25m240"];
_IFVs append ["cwr3_b_m2a2", "cwr3_b_usmc_lav25m240"];
_airborneVehicles append ["cwr3_b_usmc_lav25_hq", "cwr3_b_usmc_lav25m240"];
_tanks append ["cwr3_b_usmc_m60a3", "cwr3_b_usmc_m1"];
_lightTanks append ["cwr3_b_usmc_aav", "cwr3_b_usmc_lav25m240"];
_aa append ["cwr3_b_usmc_m163"];
...
_planesCAS append ["cwr3_b_usmc_av8b"];
_planesAA append ["cwr3_b_usmc_f4s"];

_planesTransport append ["cwr3_b_usmc_c130"];
_gunship append [];

_helisLight append ["cwr3_b_usmc_uh1"];
_transportHelicopters append ["cwr3_b_usmc_ch53e", "cwr3_b_usmc_ch53e_viv"];
_helisLightAttack append ["cwr3_b_usmc_uh1_armed", "cwr3_b_usmc_uh1_gunship"];
_helisAttack append ["cwr3_b_usmc_ah1f"];
_airPatrol append [];
...
_militiaLightArmed append ["cwr3_b_usmc_m151_m2"];
_militiaTrucks append ["cwr3_b_usmc_m939_open"];
_militiaCars append ["cwr3_b_usmc_m151"];
...
_traitorUniforms append ["cwr3_b_uniform_m81_woodland_early"];
_traitorVests append ["cwr3_b_vest_alice_officer"];
_traitorHats append ["cwr3_b_headgear_cap_m81_woodland_early"];

_officerUniforms append ["cwr3_b_uniform_m81_woodland"];
_officerVests append ["cwr3_b_vest_pasgt_alice_woodland_officer"];
_officerHats append ["cwr3_b_headgear_cap_m81_woodland"];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["cwr3_b_headgear_cap_m81_woodland"];
_SNIhats append ["cwr3_b_headgear_cap_m81_woodland"];
...
_elitevests append ["cwr3_b_vest_pasgt_alice_rifleman_mc"];
_eliteHvests append [];
_eliteMGvests append ["cwr3_b_vest_pasgt_alice_mg_mc", "cwr3_b_vest_pasgt_alice_ar_mc"];
_eliteMEDvests append ["cwr3_b_vest_pasgt_alice_medic_mc"];
_eliteSLvests append ["cwr3_b_vest_pasgt_alice_officer_mc"];
_eliteSNIvests append [];
_eliteGLvests append ["cwr3_b_vest_pasgt_alice_grenadier_mc"];
_eliteATvests append [];
_eliteENGvests append ["cwr3_b_vest_pasgt_alice_etool_mc"];
...
_elitehelmets append ["cwr3_b_headgear_pasgt_m81_woodland_usmc", "cwr3_b_headgear_pasgt_m81_woodland_usmc_goggles"];
...
_militaryuniforms append ["cwr3_b_uniform_rdf_usmc", "cwr3_b_uniform_rdf_rolled_usmc"];
_militaryENGuniforms append [];
_militarySLuniforms append ["cwr3_b_uniform_rdf_usmc"];
_militaryvests append ["cwr3_b_vest_flak_alice_rifleman_mc"];
_militaryHvests append [];
_militaryMGvests append ["cwr3_b_vest_flak_alice_mg_mc"];
_militaryMEDvests append ["cwr3_b_vest_flak_alice_light_mc"];
_militarySLvests append ["cwr3_b_vest_flak_alice_officer_mc"];
_militarySNIvests append [];
_militaryGLvests append ["cwr3_b_vest_flak_alice_grenadier_mc"];
_militaryATvests append [];
_militaryENGvests append ["cwr3_b_vest_flak_alice_etool_mc"];
...
_militaryhelmets append ["cwr3_b_headgear_m1_m81_woodland_usmc", "cwr3_b_headgear_m1_goggles_m81_woodland_usmc"];
...
_policeuniforms append ["cwr3_b_uniform_og107_usmc"];
_policeSLuniforms append [];
_policevests append ["cwr3_b_vest_alice_crew"];
_policehelmets append ["cwr3_b_headgear_cap_m81_usmc_olive"];
...
_militiauniforms append ["cwr3_b_uniform_og107_usmc"];
...
_militiahelmets append ["cwr3_b_headgear_cap_m81_usmc_olive", "cwr3_b_headgear_m1_mitchell_usmc", "cwr3_b_headgear_cap_m81_usmc_olive", "cwr3_b_headgear_m1_mitchell_usmc", "cwr3_b_headgear_m1_goggles_mitchell_usmc"];
...
_crewuniforms append ["cwr3_b_uniform_m81_woodland_usmc"];
_crewvests append ["cwr3_b_vest_flak_alice_crew_mc"];
