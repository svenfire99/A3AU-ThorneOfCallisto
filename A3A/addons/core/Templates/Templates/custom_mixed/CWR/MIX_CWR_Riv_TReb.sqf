/* Faction : Tonali Rebels
 * Converted from: CWR_Riv_TReb.sqf
 */
_unarmedVehicles append ["cwr3_trf_uaz_open", "cwr3_trf_uaz", "cwr3_trf_btr40"];
_armedVehicles append ["cwr3_trf_uaz_dshkm", "cwr3_trf_uaz_spg9", "cwr3_trf_uaz_ags30", "cwr3_trf_btr40_dshkm", "cwr3_trf_brdm2", "cwr3_trf_brdm2um"];
_Trucks append ["cwr3_trf_ural_open", "cwr3_trf_ural"];
_lightAPCs append ["cwr3_trf_btr60", "cwr3_trf_bmp1", "cwr3_trf_mtlb_pk"];
_tanks append ["cwr3_trf_t55", "CUP_I_T34_NAPA"];
_transportHelicopters append ["cwr3_trf_mi8_amt", "cwr3_trf_uh1"];
_uavsAttack append [];
...
_SLuniforms append ["cwr3_trf_uniform_denison_brush_rolled"];
_ENGuniforms append [];
_MEDuniforms append [];
_MGvests append [];
_MEDvests append [];
