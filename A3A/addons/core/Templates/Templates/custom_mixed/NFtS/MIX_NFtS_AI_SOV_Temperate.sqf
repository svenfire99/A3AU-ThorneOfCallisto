...
_repairTrucks append ["LIB_Zis6_Parm"];
_fuelTrucks append ["LIB_Zis5v_Fuel"];
_medicalTrucks append ["LIB_Zis5v_Med"];
_lightAPCs append ["LIB_Scout_M3_FFV","LIB_Scout_M3"];
_APCs append ["LIB_Scout_M3_FFV","LIB_SOV_M3_Halftrack","NORTH_SOV_T34_76_1941"];
_IFVs append ["LIB_SU85","NORTH_SOV_T34_76_1943","NORTH_SOV_T28","NORTH_SOV_T28e","NORTH_SOV_T28_com"];
_airborneVehicles append ["LIB_Scout_M3_FFV","NORTH_SOV_T60","NORTH_SOV_T70"];
_tanks append ["NORTH_SOV_KV1_1940","NORTH_SOV_KV1_1941","NORTH_SOV_KV1_1942","NORTH_SOV_KV1E_1940","NORTH_SOV_T34_85","NORTH_SOV_T34_85_45","NORTH_SOV_T34_85","NORTH_SOV_T34_85_45","LIB_JS2_43","LIB_JS2_43","LIB_JS2_43"];
...
_planesCAS append ["LIB_Pe2"];
_planesAA append ["LIB_P39"];
...
_militiaTrucks append ["LIB_Zis5v"];
_militiaCars append ["LIB_Willys_MB"];
_militiaAPCs append ["LIB_Scout_M3"];

_policeVehs append ["LIB_GazM1_SOV"];

_staticMG append ["NORTH_FIN_Maxim_High"];
_staticAT append ["NORTH_SOV_76mm1936"];
...
_traitorUniforms append ["U_LIB_SOV_Strelok_summer"];
_traitorVests append ["V_LIB_SOV_RA_OfficerVest"];
_traitorHats append ["H_LIB_SOV_RA_PrivateCap"];

_officerUniforms append ["U_LIB_SOV_Kapitan_summer"];
_officerVests append ["V_LIB_SOV_RA_OfficerVest"];
_officerHats append ["H_LIB_NKVD_OfficerCap"];
...
_sfuniforms append ["U_NORTH_SOV_Obr37_43_MKK_3"];
...
_sfhelmets append ["H_NORTH_SOV_SSh40_Helmet_camo","H_NORTH_SOV_SSh40_Helmet_camo_2","H_NORTH_SOV_SSh40_Helmet_camo_3","H_NORTH_SOV_SSh40_Helmet_camo_4","H_NORTH_SOV_SSh40_Helmet_camo_5","H_NORTH_SOV_SSh40_Helmet_camo_6"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append ["H_NORTH_SOV_Obr35_Furazhka","H_NORTH_SOV_Obr35_Furazhka_2","H_NORTH_SOV_Obr35_Furazhka_3","H_NORTH_SOV_Obr35_Furazhka_4","H_NORTH_SOV_Obr35_Furazhka_5","H_NORTH_SOV_Obr35_Furazhka_6"];
_sfSNIhats append ["H_NORTH_SOV_SSh40_Helmet_camo","H_NORTH_SOV_SSh40_Helmet_camo_2","H_NORTH_SOV_SSh40_Helmet_camo_3","H_NORTH_SOV_SSh40_Helmet_camo_4","H_NORTH_SOV_SSh40_Helmet_camo_5","H_NORTH_SOV_SSh40_Helmet_camo_6"];
...
_eliteuniforms append ["U_NORTH_SOV_Obr43_Uniform_Private","U_NORTH_SOV_Obr43_Uniform_Private_2","U_NORTH_SOV_Obr43_Uniform_Private_3","U_NORTH_SOV_Obr43_Uniform_Private_4","U_NORTH_SOV_Obr43_Uniform_Private_5","U_NORTH_SOV_Obr43_Uniform_Private_6"];
_eliteSLuniforms append ["U_NORTH_SOV_Obr43_Uniform_1stLt"];
...
_elitehelmets append ["H_NORTH_SOV_SSh40_Helmet","H_NORTH_SOV_SSh40_Helmet_2","H_NORTH_SOV_SSh40_Helmet_3","H_NORTH_SOV_SSh40_Helmet_4","H_NORTH_SOV_SSh40_Helmet_5"];
_eliteMEDhelmets append [];
_eliteSLhelmets append [];
_eliteSLhats append ["H_NORTH_SOV_Obr35_Pilotka_Off"];
_eliteSNIhats append ["H_NORTH_SOV_SSh40_Helmet_Moss_1","H_NORTH_SOV_SSh40_Helmet_Moss_2","H_NORTH_SOV_SSh40_Helmet_Moss_3"];
...
_militaryuniforms append ["U_NORTH_SOV_Obr43_Uniform_Private","U_NORTH_SOV_Obr43_Uniform_Private_2","U_NORTH_SOV_Obr43_Uniform_Private_3","U_NORTH_SOV_Obr43_Uniform_Private_4","U_NORTH_SOV_Obr43_Uniform_Private_5","U_NORTH_SOV_Obr43_Uniform_Private_6"];
_militaryENGuniforms append [];
_militarySLuniforms append ["U_NORTH_SOV_Obr43_Uniform_2ndLt","U_NORTH_SOV_Obr43_Uniform_1stLt"];
...
_militaryhelmets append ["H_NORTH_SOV_SSh39_Helmet","H_NORTH_SOV_SSh39_Helmet_2","H_NORTH_SOV_SSh40_Helmet","H_NORTH_SOV_SSh40_Helmet_2","H_NORTH_SOV_SSh40_Helmet_3","H_NORTH_SOV_SSh40_Helmet_4","H_NORTH_SOV_SSh40_Helmet_5"];
_militaryMEDhelmets append [];
_militarySLhelmets append [];
_militarySLhats append ["H_NORTH_SOV_Obr35_Pilotka_Off"];
_militarySNIhats append ["H_NORTH_SOV_SSh40_Helmet_Moss_1","H_NORTH_SOV_SSh40_Helmet_Moss_2","H_NORTH_SOV_SSh40_Helmet_Moss_3"];
...
_policeuniforms append ["U_NORTH_SOV_Obr43_Uniform_NKVD_Private_1CL","U_NORTH_SOV_Obr43_Uniform_NKVD_Private_1CL_2","U_NORTH_SOV_Obr43_Uniform_NKVD_Private_1CL_3","U_NORTH_SOV_Obr43_Uniform_NKVD_Private_1CL_4"];
...
_policehelmets append ["H_NORTH_SOV_Obr35_Furazhka_NKVD","H_NORTH_SOV_Obr35_Furazhka_NKVD_2","H_NORTH_SOV_Obr35_Furazhka_NKVD_3","H_NORTH_SOV_Obr35_Furazhka_NKVD_4"];
...
_militiauniforms append ["U_NORTH_SOV_Obr35_Uniform_Early_Private","U_NORTH_SOV_Obr35_Uniform_Early_Private_2","U_NORTH_SOV_Obr35_Uniform_Early_Private_3","U_NORTH_SOV_Obr35_Uniform_Early_Private_4","U_NORTH_SOV_Obr35_Uniform_Early_Private_5","U_NORTH_SOV_Obr35_Uniform_Early_Private_6"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append ["U_NORTH_SOV_Obr35_Uniform_Early_2ndLt","U_NORTH_SOV_Obr35_Uniform_Early_2ndLt_2"];
...
_militiahelmets append ["H_NORTH_SOV_Obr35_Pilotka","H_NORTH_SOV_Obr35_Pilotka_2","H_NORTH_SOV_Obr35_Pilotka_3","H_NORTH_SOV_Obr35_Pilotka_4","H_NORTH_SOV_SSh36_Helmet","H_NORTH_SOV_SSh36_Helmet_2","H_NORTH_SOV_SSh36_Helmet_3","H_NORTH_SOV_SSh36_Helmet_4"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append ["H_NORTH_SOV_Obr35_Furazhka","H_NORTH_SOV_Obr35_Furazhka_2","H_NORTH_SOV_Obr35_Furazhka_3","H_NORTH_SOV_Obr35_Furazhka_4","H_NORTH_SOV_Obr35_Furazhka_5","H_NORTH_SOV_Obr35_Furazhka_6"];
_militiaSNIhats append ["H_NORTH_SOV_Obr35_Pilotka","H_NORTH_SOV_Obr35_Pilotka_2","H_NORTH_SOV_Obr35_Pilotka_3","H_NORTH_SOV_Obr35_Pilotka_4"];
