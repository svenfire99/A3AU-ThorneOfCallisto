/* Faction : Norges Opprorere
 * Converted from: NFtS_Reb_NOR_Arctic.sqf
 */
...
_staticMG append ["NORTH_FIN_Maxim"];
_staticAT append ["NORTH_FIN_45PSTK37"];
_staticAA append ["NORTH_FIN_Lahti_L39AA","NORTH_SOV_Maxim_Quad"];
_staticMortars append ["NORTH_SOV_50rm38"];
_howitzers append [];
_radar append [];
_SAM append [];
...
_faces append ["LIB_aleksei_IF","LIB_boyartsev_IF","LIB_bykov_IF",
"LIB_Otto_IF","LIB_Volker_IF", "LIB_Walter_IF", "LIB_Wolf_IF"];
_voices append ["Male01FIN", "Male02FIN", "Male03FIN", "Male04FIN"];
_sfVoices append [];
_eliteVoices append [];
