...
_vehiclesLightArmed append ["a3u_black_Pickup_mmg_alt_rf", "a3u_black_Pickup_mmg_frame_rf","I_G_Pickup_hmg_rf", "AU_I_G_Pickup_Minigun_RF"];
...
_vehiclesAt pushBack "B_G_Pickup_Rocket_rf";