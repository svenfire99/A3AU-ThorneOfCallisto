...
_militaryvests append ["BWA3_Vest_Fleck", "BWA3_Vest_Rifleman_Fleck"];
...
if (isClass (configFile >> "CfgPatches" >> "CUP_AirVehicles_Core") && !isClass (configFile >> "CfgFactionClasses" >> "rhs_faction_usarmy")) then {
    ...
    _repairTrucks = ["CUP_B_nM1038_Repair_DF_USA_WDL", "CUP_B_nM1038_Repair_USA_WDL", "CUP_B_MTVR_Repair_USMC"];
    _fuelTrucks = ["CUP_B_MTVR_Refuel_USMC"];
    _medicalTrucks = ["CUP_B_nM997_DF_USA_WDL", "CUP_B_nM997_USA_WDL", "CUP_B_M1133_MEV_Woodland"];
...
if (isClass (configFile >> "CfgFactionClasses" >> "rhs_faction_usarmy") && !isClass (configFile >> "CfgPatches" >> "CUP_AirVehicles_Core")) then {
    ...
    if (!_hasGM) then {
        ...
        _ammoTrucks = ["rhsusf_M977A4_AMMO_usarmy_wd", "rhsusf_M977A4_AMMO_BKIT_usarmy_wd", "rhsusf_M977A4_AMMO_BKIT_M2_usarmy_wd"];
        _repairTrucks = ["rhsusf_M977A4_REPAIR_usarmy_wd", "rhsusf_M977A4_REPAIR_BKIT_M2_usarmy_wd", "rhsusf_M977A4_REPAIR_BKIT_usarmy_wd"];
...
if (isClass (configfile >> "CfgPatches" >> "Redd_Marder_1A5")) then {
    ...
    if (!_hasGM) then {
        ...
        _policeVehs = ["Redd_Tank_LKW_leicht_gl_Wolf_Flecktarn_FJg"];
    };
};
...
if (_hasGM) then {
    ...
    _lightTanks = ["gm_ge_army_Leopard1a1","gm_ge_army_Leopard1a1a1","gm_ge_army_Leopard1a1a2","gm_ge_army_Leopard1a3","gm_ge_army_Leopard1a3a1","gm_ge_army_Leopard1a5"];
