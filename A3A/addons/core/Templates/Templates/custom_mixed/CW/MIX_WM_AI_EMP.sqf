...
_radios append ["ls_radios_cwp8"];
_gpses append ["ItemGPS"];
_NVGs append ["lsd_gar_standard_nvg"];
_binoculars append ["ls_clone_electrobinoculars"];
_rangefinders append ["ls_clone_electrobinocularsCommander"];

_traitorUniforms append ["WM_OfficerUniform"];
_traitorVests append ["WM_Officer_armor"];
_traitorHats append ["WM_OfficerHelmet"];

_officerUniforms append ["WM_OfficerUniform"];
_officerVests append ["WM_Officer_armor"];
_officerHats append ["WM_OfficerCap"];
...
_militaryuniforms append ["WM_StormArmor"];
_militaryENGuniforms append [];
_militarySLuniforms append [];
_militaryvests append ["WM_Basic_armor", "WM_Basic_armor", "WM_Basic_armor", "WM_Basic_armor"];
_militaryHvests append ["WM_Basic_armor", "WM_Basic_armor", "WM_Pauldron", "WM_SGT_Pauldron", "WM_SL_Pauldron", "WM_UTL_Pauldron"];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append [];
_militarySNIvests append [];
_militaryGLvests append ["WM_Basic_armor"];
_militaryATvests append [];
_militaryENGvests append [];
_militarybackpacks append ["WM_Stormtrooper_Backpack", "WM_Stormtrooper_Backpack_RTO"];
...
_militaryhelmets append ["WM_StormHelmet"];
_militaryMEDhelmets append [];
_militarySLhelmets append [];
_militarySLhats append ["WM_StormHelmet"];
_militarySNIhats append ["WM_StormHelmet"];
...
_policevests append ["WM_Pauldron","WM_ScoutVest","WM_ScoutVest","WM_ScoutVest"];
...
_militiabackpacks append ["WM_Stormtrooper_Backpack", "WM_Stormtrooper_Backpack_RTO"];
