...
_traitorUniforms append ["SE_Assault_Fatigues_Monolith"];
_traitorVests append ["SCE_Sunrise_Black"];
_traitorHats append ["armst_Hood_closed_mono"];

_officerUniforms append ["SE_Assault_Fatigues_Monolith"];
_officerVests append ["SCE_V_SEVA_Monolith"];
_officerHats append ["armst_Hood_mid_mono"];
