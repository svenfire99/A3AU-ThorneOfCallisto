...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["CUP_H_RUS_6B27_headset"];
_SNIhats append ["H_Beret_blk"];
...
_sfradios append [];
_sfgpses append [];
_sfNVGs append ["CUP_NVG_GPNVG_Hide"];
...
_sfvests append ["SCE_V_SEVA_Loner_6", "SCE_V_SEVA_ClearSky"];
_sfHvests append [];
_sfMGvests append ["SCE_Exo2G_loner_2"];
_sfMEDvests append ["SCE_V_SEVA_ClearSky"];
_sfSLvests append [];
_sfSNIvests append [];
_sfGLvests append ["SCE_Exo2G_loner_2"];
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["SCE_B_SEVA_ClearSky"];
_sfATBackpacks append ["SCE_B_SEVA_Loner_6"];
...
_sfSLhelmets append [];
_sfSLhats append ["SCE_H_SEVA_ClearSky"];
_sfSNIhats append ["SCE_H_SEVA_ClearSky"];
...
_eliteuniforms append ["SCE_ClearSky_1"];
_eliteSLuniforms append ["SCE_ClearSky_CBRN"];
_elitevests append ["SCE_Sunrise_Black"];
_eliteHvests append [];
...
_elitebackpacks append ["B_AssaultPack_blk"];
_eliteATBackpacks append ["CUP_B_Bergen_BAF"];
...
_eliteSLBackpacks append ["SE_Scavenger_Backpack"];
_elitelongRangeRadios append [];
_elitehelmets append ["CUP_H_USArmy_Helmet_ECH1_Black", "CUP_H_RUS_K6_3_black"];
...
_militaryvests append ["SCE_Sunrise_Black"];
_militaryHvests append [];
_militaryMGvests append ["SCE_V_SEVA_ClearSky"];
_militaryMEDvests append ["SCE_V_SEVA_ClearSky"];
_militarySLvests append ["SCE_V_SEVA_ClearSky"];
_militarySNIvests append [];
_militaryGLvests append ["SCE_V_SEVA_ClearSky"];
_militaryATvests append [];
_militaryENGvests append ["SCE_V_SEVA_ClearSky"];
_militarybackpacks append ["B_AssaultPack_blk"];
_militaryATBackpacks append ["CUP_B_Bergen_BAF"];
...
_militaryhelmets append ["CUP_H_USArmy_Helmet_ECH1_Black", "CUP_H_RUS_K6_3_black"];
...
_policevests append ["SE_Eastern_Chest_Rig_Black", "SCE_Sunrise_Black"];
_policehelmets append ["CUP_H_PMC_Cap_Grey", "CUP_H_PMC_Cap_Back_PRR_Grey"];
...
_militiauniforms append ["SCE_ClearSky_2"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append [];
_militiavests append ["CUP_V_B_Interceptor_Base_Grey"];
_militiaHvests append [];
_militiaMGvests append [];
_militiaMEDvests append [];
_militiaSLvests append [];
_militiaSNIvests append ["SCE_Sunrise_Black"];
_militiaGLvests append [];
_militiaATvests append [];
_militiaENGvests append [];
_militiabackpacks append ["CUP_B_AssaultPack_Black"];
...
_militiaSLBackpacks append ["CUP_B_USPack_Black"];
_militialongRangeRadios append [];
_militiahelmets append ["CUP_H_PMC_Beanie_Black", "CUP_H_PMC_Beanie_Headphones_Black"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append [];
_militiaSNIhats append ["H_Beret_blk"];
...
_crewhelmets append ["CUP_H_Ger_M92_Black_GG"];
...
_pilothelmets append ["CUP_H_Ger_M92_Black_GG"];
