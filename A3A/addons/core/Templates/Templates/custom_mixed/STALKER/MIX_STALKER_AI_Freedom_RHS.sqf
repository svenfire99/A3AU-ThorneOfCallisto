/* Faction : Freedom
 * Converted from: STALKER_AI_Freedom_RHS.sqf
 */
...
_lightAPCs append ["rhsgref_BRDM2_msv", "rhsgref_BRDM2_HQ_msv", "rhsgref_BRDM2_ATGM_msv", "rhsusf_m113_usarmy"];
_APCs append ["rhs_btr70_msv", "rhs_btr80_msv", "rhs_btr80a_msv" ];
_IFVs append ["rhs_bmp1p_msv", "rhs_Ob_681_2" ];
_airborneVehicles append ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_BRDM2_msv", "rhsusf_m1151_m2_v1_usarmy_wd"];
...
_MEDhelmets append [];
_SLhelmets append [];
_SLhats append ["rhsgref_helmet_pasgt_flecktarn"];
_SNIhats append ["armst_Hood_full_freedom1"];
...
_sfuniforms append ["SCE_Freedom_CBRN"];
_sfMEDuniforms append [];
_sfENGuniforms append [];
_sfSLuniforms append [];
_sfvests append ["SCE_Exo2G_Freedom_1"];
_sfHvests append [];
_sfMGvests append ["SCE_Exo2G_Freedom_2"];
_sfMEDvests append ["SCE_Exo2G_Freedom_1"];
_sfSLvests append [];
_sfSNIvests append [];
_sfGLvests append ["SCE_Exo2G_Freedom_2"];
_sfATvests append [];
_sfENGvests append [];
...
_sfhelmets append ["SCE_Exo_Helmet_Freedom"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append ["SCE_Exo_Helmet_Freedom"];
_sfSNIhats append ["SCE_Exo_Helmet_Freedom"];
...
_eliteuniforms append ["SCE_Freedom_CBRN"];
_eliteSLuniforms append ["SCE_Freedom_CBRN"];
_elitevests append ["SCE_V_SEVA_Freedom_2"];
_eliteHvests append [];
_eliteMGvests append ["SCE_V_SEVA_Freedom_2"];
_eliteMEDvests append ["SCE_V_SEVA_Freedom_2"];
_eliteSLvests append ["SCE_V_SEVA_Freedom_2"];
_eliteSNIvests append [];
_eliteGLvests append ["SCE_V_SEVA_Freedom_2"];
_eliteATvests append [];
_eliteENGvests append ["SCE_V_SEVA_Freedom_2"];
_elitebackpacks append ["SCE_B_SEVA_Freedom_2"];
...
_eliteSLBackpacks append ["SCE_B_SEVA_Freedom_2"];
_elitelongRangeRadios append [];
_elitehelmets append ["SCE_H_SEVA_Freedom_2"];
_eliteMEDhelmets append [];
_eliteSLhelmets append [];
_eliteSLhats append [];
_eliteSNIhats append ["SCE_H_SEVA_Freedom_2"];
...
_militaryvests append ["SCE_Sunrise_Freedom_1"];
_militaryHvests append [];
_militaryMGvests append ["SCE_V_SEVA_Freedom_2"];
_militaryMEDvests append ["SCE_Sunrise_Freedom_2"];
_militarySLvests append ["SCE_Sunrise_Freedom_1"];
_militarySNIvests append [];
_militaryGLvests append ["SCE_V_SEVA_Freedom_2"];
_militaryATvests append [];
_militaryENGvests append ["SCE_Sunrise_Freedom_1"];
...
_militaryhelmets append ["rhsgref_helmet_pasgt_flecktarn", "armst_Hood_full_freedom1"];
...
_policevests append ["SE_Eastern_Chest_Rig_Green", "SCE_Coat_Short_4"];
_policehelmets append ["armst_Hood_closed_freedom2", "rhssaf_bonniehat_digital"];
...
_militiavests append ["SE_Assault_Vest_Green"];
_militiaHvests append [];
_militiaMGvests append [];
_militiaMEDvests append [];
_militiaSLvests append [];
_militiaSNIvests append ["SE_Eastern_Chest_Rig_Brown"];
_militiaGLvests append [];
_militiaATvests append [];
_militiaENGvests append [];
_militiabackpacks append ["SE_Satchel_Bag"];
...
_militiaSLBackpacks append ["SE_Explorer_Backpack"];
_militialongRangeRadios append [];
_militiahelmets append ["rhsgref_helmet_pasgt_flecktarn"];
