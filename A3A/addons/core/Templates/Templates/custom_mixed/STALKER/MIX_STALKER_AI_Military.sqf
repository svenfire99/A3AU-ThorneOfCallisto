...
_traitorHats append ["CUP_H_CZ_Patrol_Cap"];

_officerUniforms append ["CUP_U_O_RUS_VSR98_worn_gloves_MSV"];
_officerVests append ["CUP_V_CZ_vest01"];
_officerHats append ["CUP_H_CZ_Patrol_Cap"];
