...
_tanks append [];
_lightTanks append [];
_aa append ["CUP_I_Ural_ZU23_NAPA"];
...
_staticMG append ["gm_gc_army_dshkm_aatripod"];
_staticAT append ["gm_gc_army_spg9_tripod"];
...
_voices append ["gm_voice_male_deu_08", "gm_voice_male_deu_03", "gm_voice_male_deu_05","gm_voice_male_deu_07", "gm_voice_male_deu_01"];
_sfVoices append [];
_eliteVoices append [];
