...
_cargoTrucks append ["gm_gc_army_ural4320_cargo_olw", "gm_gc_army_ural375d_cargo_olw", "gm_gc_army_ural375d_cargo_un", "gm_gc_army_ural4320_cargo_un", "gm_gc_army_ural4320_cargo_win", "gm_gc_army_ural375d_cargo_win", "gm_gc_army_ural44202_win", "gm_gc_army_ural44202_un", "gm_gc_army_ural44202_olw"];
_ammoTrucks append ["gm_gc_army_ural4320_reammo_win", "gm_gc_army_ural4320_reammo_un", "gm_gc_army_ural4320_reammo_olw"];
_repairTrucks append ["gm_gc_army_ural4320_repair_win", "gm_gc_army_ural4320_repair_un", "gm_gc_army_ural4320_repair_olw"];
_fuelTrucks append ["gm_gc_army_ural375d_refuel_un", "gm_gc_army_ural375d_refuel_olw", "gm_gc_army_ural375d_refuel_win"];
_medicalTrucks append ["gm_gc_army_ural375d_medic_win", "gm_gc_army_ural375d_medic_un", "gm_gc_army_ural375d_medic_olw"];
_lightAPCs append ["gm_gc_army_btr60pb_win", "gm_gc_army_btr60pb_un", "gm_gc_army_btr60pb_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU", 
...
_APCs append ["gm_pl_army_ot64a_olw", "gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BTR80_CAMO_RU", "CUP_O_BTR80A_CAMO_RU"];
_IFVs append ["gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU"];
_airborneVehicles append ["gm_gc_army_btr60pb_win", "gm_gc_army_btr60pb_un", "gm_gc_army_btr60pb_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU", 
    "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU", "gm_gc_army_btr60pa_dshkm_win", "gm_gc_army_btr60pa_dshkm_un", "gm_gc_army_btr60pa_dshkm_olw"];
_tanks append ["gm_gc_army_pt76b_win", "gm_gc_army_t55_win", "gm_gc_army_t55a_win", "gm_gc_army_t55ak_win", "gm_gc_army_t55am2_win", "gm_gc_army_t55am2b_win", "gm_gc_army_pt76b_un", "gm_gc_army_t55_un", "gm_gc_army_t55a_un", "gm_gc_army_t55ak_un", "gm_gc_army_t55am2_un", "gm_gc_army_t55am2_un", "gm_gc_army_pt76b_olw", "gm_gc_army_t55_olw", "gm_gc_army_t55a_olw", "gm_gc_army_t55ak_olw", "gm_gc_army_t55am2_olw", "gm_gc_army_t55am2b_olw"];
_lightTanks append ["gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU"];
_aa append ["gm_gc_army_zsu234v1_win", "gm_gc_army_zsu234v1_un", "gm_gc_army_zsu234v1_olw", "CUP_O_Ural_ZU23_RU"];
...
_Amphibious append ["gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU", "CUP_O_BTR80A_CAMO_RU","gm_gc_army_brdm2_win", "gm_gc_army_brdm2_un", "gm_gc_army_brdm2_olw", "gm_gc_army_btr60pa_win", "gm_gc_army_btr60pa_un", "gm_gc_army_btr60pa_olw",
...
_helisLight append ["gm_pl_airforce_mi2ch_un", "gm_gc_airforce_mi2p_un"];
_transportHelicopters append ["gm_gc_airforce_mi2t_un", "gm_pl_airforce_mi2t_un", "CUP_O_Mi8AMT_RU"];
_helisLightAttack append ["gm_gc_airforce_mi2urn_un", "gm_gc_airforce_mi2us_un", "gm_pl_airforce_mi2urp_un", "gm_pl_airforce_mi2urpg_un", "CUP_O_Mi8_RU"];
_helisAttack append ["CUP_O_Mi24_P_Dynamic_RU"];
_airPatrol append [];

_artillery append ["gm_gc_army_2s1_win", "gm_gc_army_ural375d_mlrs_win", "gm_gc_army_2s1_un", "gm_gc_army_ural375d_mlrs_un", "gm_gc_army_2s1_olw", "gm_gc_army_ural375d_mlrs_olw"];
...
_militiaLightArmed append ["gm_pl_army_uaz469_dshkm_olw"];
_militiaTrucks append ["gm_pl_army_ural4320_cargo_olw"];
_militiaCars append ["gm_pl_army_uaz469_cargo_olw"];
_militiaAPCs append ["gm_gc_army_btr60pb_win", "gm_gc_army_btr60pb_un", "gm_gc_army_btr60pb_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU", 
    "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU", "gm_gc_army_btr60pa_dshkm_win", "gm_gc_army_btr60pa_dshkm_un", "gm_gc_army_btr60pa_dshkm_olw"];
...
_sfuniforms append ["gm_gc_army_uniform_soldier_80_win"];
...
_sfhelmets append ["gm_gc_army_headgear_m56_cover_win"];
...
_eliteuniforms append ["gm_gc_army_uniform_soldier_80_win"];
...
_elitehelmets append ["gm_gc_army_headgear_m56_cover_win"];
...
_militaryuniforms append ["gm_gc_army_uniform_soldier_80_win"];
...
_militaryhelmets append ["gm_gc_army_headgear_m56_cover_win"];
...
_militiauniforms append ["gm_pl_army_uniform_soldier_80_win"];
...
_militiahelmets append ["gm_pl_headgear_wz67_cover_win"];
