...
_repairTrucks append ["RHS_Ural_Repair_VMF_01"];
_fuelTrucks append ["rhssaf_army_o_ural_fuel"];
_medicalTrucks append ["rhs_gaz66_ap2_msv"];
_lightAPCs append ["rhsgref_cdf_btr60", "rhsgref_cdf_btr70", "rhsgref_cdf_btr80", "rhsgref_BRDM2_HQ", "rhsgref_BRDM2"];
_APCs append ["rhs_bmp1d_vmf", "rhs_bmp1k_vmf", "rhs_bmp1p_vmf", "rhs_bmp2e_vmf"];
_IFVs append [];
_airborneVehicles append ["rhsgref_cdf_btr60", "rhsgref_cdf_btr70", "rhsgref_cdf_btr80", "rhsgref_BRDM2_HQ", "rhsgref_BRDM2"];
_tanks append ["rhssaf_army_o_t72s", "rhssaf_army_o_t72s", "rhs_t72be_tv", "rhs_t72be_tv", "rhs_t72bb_tv", "rhs_t72bb_tv"];
_lightTanks append ["rhs_bmp1d_vmf", "rhs_bmp1k_vmf", "rhs_bmp1p_vmf", "rhs_bmp2e_vmf"];
...
_Amphibious append ["rhsgref_cdf_btr80", "rhs_tigr_sts_vmf", "rhs_bmp2k_vmf"];

_planesCAS append ["rhsgref_cdf_su25", "rhssaf_airforce_l_18"];
_planesAA append ["rhssaf_airforce_o_l_18_101"];

_planesTransport append ["RHS_C130J"];
_gunship append [];

_helisLight append ["rhssaf_airforce_o_ht40"];
_transportHelicopters append ["rhssaf_airforce_o_ht40", "rhssaf_airforce_o_ht48"];
_helisLightAttack append ["RHS_Mi8MTV3_vvsc", "RHS_Mi8MTV3_heavy_vvsc", "RHS_Mi24Vt_vvsc", "rhsgref_cdf_reg_Mi17Sh"];
_helisAttack append ["rhsgref_cdf_Mi24D", "rhsgref_cdf_Mi35", "rhsgref_mi24g_CAS"];
_airPatrol append [];
...
_militiaLightArmed append ["rhs_tigr_sts_3camo_vmf", "rhs_tigr_sts_vmf"];
_militiaTrucks append ["rhs_zil131_vmf", "RHS_Ural_VMF_01", "RHS_Ural_Open_VMF_01", "rhs_zil131_open_vmf", "rhs_zil131_flatbed_vmf"];
_militiaCars append ["rhs_uaz_vmf", "rhs_uaz_open_vmf", "rhs_tigr_m_vmf", "rhs_tigr_m_3camo_vmf"];
_militiaAPCs append ["rhsgref_cdf_btr60", "rhsgref_BRDM2_HQ"];

_policeVehs append ["rhs_tigr_vmf", "rhs_uaz_open_vmf"];
...
_sfvests append ["rhs_6b45_rifleman", "rhs_6b45_rifleman_2"];
_sfHvests append [];
_sfMGvests append [];
_sfMEDvests append [];
_sfSLvests append ["rhs_6b45_off"];
_sfSNIvests append [];
_sfGLvests append ["rhs_6b45_grn"];
_sfATvests append [];
_sfENGvests append [];
_sfbackpacks append ["rhssaf_kitbag_digital", "rhs_tortila_emr", "B_TacticalPack_rgr"];
...
_sfhelmets append ["rhs_Booniehat_digi", "rhsusf_opscore_fg", "rhsusf_opscore_fg_pelt", "rhsusf_opscore_fg_pelt_cam", "rhsusf_opscore_fg_pelt_nsw"];
_sfMEDhelmets append [];
_sfSLhelmets append [];
_sfSLhats append ["rhssaf_beret_red"];
_sfSNIhats append [];
...
_eliteSMGs append ["rhs_weap_scorpion"];
...
_eliteuniforms append ["rhssaf_uniform_m10_digital_summer"];
_eliteSLuniforms append [];
_elitevests append ["rhs_6b23_6sh92", "rhs_6b23_rifleman"];
_eliteHvests append [];
_eliteMGvests append [];
_eliteMEDvests append [];
_eliteSLvests append ["rhs_6b23_6sh92_headset_mapcase"];
_eliteSNIvests append [];
_eliteGLvests append ["rhs_6b23_6sh92_vog"];
_eliteATvests append [];
_eliteENGvests append [];
_elitebackpacks append ["rhs_assault_umbts", "rhssaf_alice_md2camo", "rhs_assault_umbts_engineer_empty"];
...
_elitehelmets append ["rhssaf_helmet_m97_woodland", "rhssaf_helmet_m97_woodland_black_ess", "rhssaf_helmet_m97_woodland_black_ess_bare","rhssaf_helmet_m97_olive_nocamo"];
...
_militarySMGs append ["rhs_weap_scorpion"];
...
_militaryuniforms append ["rhssaf_uniform_m10_digital_summer"];
_militaryENGuniforms append [];
_militarySLuniforms append [];
_militaryvests append ["rhs_6b23_6sh92", "rhs_6b23_rifleman"];
_militaryHvests append [];
_militaryMGvests append [];
_militaryMEDvests append [];
_militarySLvests append ["rhs_6b23_6sh92_headset_mapcase"];
_militarySNIvests append [];
_militaryGLvests append ["rhs_6b23_6sh92_vog"];
_militaryATvests append [];
_militaryENGvests append [];
_militarybackpacks append ["rhs_assault_umbts", "rhssaf_alice_md2camo", "rhs_assault_umbts_engineer_empty"];
...
_militaryhelmets append ["rhssaf_helmet_m97_woodland", "rhssaf_helmet_m97_woodland_black_ess", "rhssaf_helmet_m97_woodland_black_ess_bare","rhssaf_helmet_m97_olive_nocamo"];
...
_policeuniforms append ["rhs_uniform_omon"];
_policeSLuniforms append [];
_policevests append ["V_TacVest_oli"];
_policehelmets append ["rhssaf_beret_black", "rhs_omon_cap"];
_policeWeapons append ["rhs_weap_pp2000"];
...
_militiaSMGs append ["rhs_weap_scorpion"];
_militiamachineGuns append ["rhs_weap_m84"];
...
_militiauniforms append ["rhssaf_uniform_m93_oakleaf"];
_militiaMEDuniforms append [];
_militiaENGuniforms append [];
_militiaSLuniforms append [];
_militiavests append ["V_TacVest_oli"];
_militiaHvests append [];
_militiaMGvests append [];
_militiaMEDvests append [];
_militiaSLvests append ["V_TacVest_oli", "V_Chestrig_oli"];
_militiaSNIvests append [];
_militiaGLvests append ["V_BandollierB_oli"];
_militiaATvests append [];
_militiaENGvests append [];
_militiabackpacks append ["B_TacticalPack_oli"];
...
_militiahelmets append ["rhs_fieldcap_vsr", "rhssaf_bandana_oakleaf", "rhssaf_helmet_m59_85_nocamo"];
_militiaMEDhelmets append [];
_militiaSLhelmets append [];
_militiaSLhats append [];
_militiaSNIhats append ["rhssaf_booniehat_md2camo"];
...
_crewuniforms append ["rhs_uniform_afghanka_grey"];
_crewvests append ["rhsgref_otv_khaki"];
_crewhelmets append ["rhssaf_helmet_m97_olive_nocamo"];
...
_pilotuniforms append ["rhssaf_uniform_mig29_pilot"];
_pilotvests append ["rhsgref_chestrig"];
_pilotbackpacks append [];
_pilothelmets append ["rhs_zsh7a_mike_alt", "rhs_zsh7a_mike", "rhs_zsh7a_mike_green", "rhs_zsh7a_mike_green_alt"];
