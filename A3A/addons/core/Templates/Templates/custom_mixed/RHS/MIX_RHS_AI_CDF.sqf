...
_repairTrucks append ["rhsgref_cdf_b_gaz66_repair", "rhsgref_cdf_b_ural_repair"];
...
_lightTanks append ["rhsgref_cdf_b_bmd1k"];
...
_planesCAS append ["rhs_l39_cdf_b_cdf", "rhs_l159_cdf_b_CDF", "rhsgref_cdf_b_su25"];
...
_militiaCars append ["rhsgref_cdf_b_reg_uaz", "rhsgref_cdf_b_reg_uaz_open"];
_militiaAPCs append ["rhsgref_cdf_b_btr60", "rhsgref_cdf_b_btr70"];
...
_policehelmets append ["H_Bandanna_blu", "H_Beret_blk", "rhs_fieldcap_m88_moldovan_ttsko_blue", "rhs_fieldcap_m88_moldovan_ttsko_blue_back"];
